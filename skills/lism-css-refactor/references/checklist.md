...
- **参照先**: [`naming.md`](../../lism-css-guide/naming.md)、[`css-rules.md#独自プレフィックス`](../../lism-css-guide/css-rules.md#独自プレフィックス)、[`css-rules.md#b--とc--の使い分け`](../../lism-css-guide/css-rules.md#b--とc--の使い分け)、[`antipatterns-layout.md#クラス名の命名ミス`](../../lism-css-guide/antipatterns-layout.md#クラス名の命名ミス)、[`antipatterns-layout.md#css管理する部品を-c---のままにする`](../../lism-css-guide/antipatterns-layout.md#css管理する部品を-c---のままにする)。
