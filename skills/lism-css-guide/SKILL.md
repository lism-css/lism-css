...
> **バージョン情報:** このガイドは`lism-css@0.23.0`/`@lism-css/ui@0.23.0`時点の情報に基づきます。プロジェクトで使用中のバージョンが異なる場合は、その差分を確認してから判断してください。
>
...
`lism skill add`を再実行してください。更新があるか確認したい場合は、GitHubリポジトリの`skills/lism-css-guide`を確認してください。
