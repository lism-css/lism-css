...
- `is--fullwide` (`isFullwide` prop): [trait-class/is--fullwide.md](./trait-class/is--fullwide.md)
- `is--bleed` (`isBleed` prop): [trait-class/is--bleed.md](./trait-class/is--bleed.md)
...
- `-max-sz:*`: [property-class/max-sz.md](./property-class/max-sz.md)（旧 `-max-sz:full` / `-max-sz:container` は `is--fullwide` / `is--bleed` に置き換え）
