...
| `set-class.md` | `set--`クラス (`set--plain`,`set--revert`,`set--var:sh`,`set--var:hov`,`set--var:bdrsInner`) の一覧と用途解説 | `packages/lism-css/src/scss/base/set/`, `packages/lism-css/src/scss/base/tokens/_shadow.scss` |
...
| 確認したい内容 | 参照先 |
|---|---|
| set-- クラス一覧 | `packages/lism-css/src/scss/base/set/` 配下の SCSS、`packages/lism-css/src/scss/base/tokens/_shadow.scss`（set--var:sh） |
