...
ボックス全体をクリック可能なリンク領域にする Trait プリミティブ。

## 基本情報

- クラス名: `is--boxLink`
- コンポーネント: `<BoxLink>`
- SCSSソース: https://raw.githubusercontent.com/lism-css/lism-css/main/packages/lism-css/src/scss/modules/trait/_boxLink.scss
