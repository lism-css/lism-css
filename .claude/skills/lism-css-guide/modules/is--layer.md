...
- クラス名: `is--layer`
- コンポーネント: `<Layer>`
- SCSSソース: https://raw.githubusercontent.com/lism-css/lism-css/main/packages/lism-css/src/scss/modules/state/_layer.scss
- ドキュメント（人間向け）: https://lism-css.com/docs/modules/is--layer/
