...
複数列 ↔ 1列の切り替えをコンテナクエリやメディアクエリを使わずに実装するレイアウトモジュール。Flexbox ベースで、親コンテナ幅に応じて自動的に折り返します。

## 基本情報

- クラス名: `l--switchCols`
- コンポーネント: `<SwitchCols>`
- SCSSソース: https://raw.githubusercontent.com/lism-css/lism-css/main/packages/lism-css/src/scss/modules/layout/_switchCols.scss
- ドキュメント（人間向け）: https://lism-css.com/docs/modules/l--switchcols/
