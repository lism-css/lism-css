...
要素を上下左右中央揃えで配置するレイアウトモジュール。高さの有無で水平中央のみ / 上下左右中央を自動的に切り替えます。

## 基本情報

- クラス名: `l--center`
- コンポーネント: `<Center>`
- SCSSソース: https://raw.githubusercontent.com/lism-css/lism-css/main/packages/lism-css/src/scss/modules/layout/_center.scss
- ドキュメント（人間向け）: https://lism-css.com/docs/modules/l--center/
