...
HTML では直接クラスを付与し、Lism コンポーネントでは対応する Props（`setPlain`, `setShadow` 等）で指定します。
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_plain.scss
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/tokens/_shadow.scss
...
```
```jsx
<Box setShadow bxsh='20' style={{ '--shc': 'hsl(200 50% 50% / 20%)' }}>...</Box>
```
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_hov.scss
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_transition.scss
...
```
```jsx
<Lism setTransition hov={{c: 'red'}} style={{ '--hov-prop': 'color'}}>...</Lism>
```
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_gutter.scss
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_innerRs.scss
...
```
```jsx
<Lism className="set--innerRs" p="15" bdrs="40" bd>
...
- ソース: https://github.com/lism-css/lism-css/blob/dev/packages/lism-css/src/scss/base/set/_bp.scss
...
```
```jsx
<Lism setBp p="20" style={{ color: 'var(--_is_sm) red;' }}>...</Lism>
```
