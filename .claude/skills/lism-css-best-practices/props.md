...
| `g` | `gap` | `g='20'` | `.-g:20` |
| `cg` | `column-gap` | `cg='20'` | `.-cg:20` |
| `rg` | `row-gap` | `rg='20'` | `.-rg:20` |
...
| `fxd` | `flex-direction` | `fxd='column'` | `.-fxd:column` |
| `gtc`, `gtr` | `grid-template` 系 | `gtc='1fr 1fr'` | `.-gtc` + `--gtc: 1fr 1fr` |

Prop Class の値名は CSS の実値と同じです（例: `.-pos:relative`, `.-fxd:column`）。  
ただし、以下の値は例外として省略形が使われます。

| Class 値 | 元の CSS 値 | 対象 Prop |
|----------|------------|-----------|
| `upper` | `uppercase` | `tt` |
| `lower` | `lowercase` | `tt` |
| `fit` | `fit-content` | `w`, `h` |
| `between` | `space-between` | `ac`, `jc` |
| `current` | `currentColor` | `bdc` |
