...
describe('getFilterProps', () => {
  describe('基本的なfilter処理', () => {
    test('blur を filter に変換する', () => {
      ...
      expect('blur' in result).toBe(false);
    });
    ...
    test('contrast を filter に変換する', () => {
      ...
      expect('contrast' in result).toBe(false);
    });
    ...
    test('brightness を filter に変換する', () => {
      ...
      expect('brightness' in result).toBe(false);
    });
    ...
    test('dropShadow を drop-shadow に変換する', () => {
      ...
      expect('dropShadow' in result).toBe(false);
    });
    ...
    test('grayscale を filter に変換する', () => {
      ...
      expect('grayscale' in result).toBe(false);
    });
    ...
    test('hueRotate を hue-rotate に変換する', () => {
      ...
      expect('hueRotate' in result).toBe(false);
    });
    ...
    test('invert を filter に変換する', () => {
      ...
      expect('invert' in result).toBe(false);
    });
    ...
    test('saturate を filter に変換する', () => {
      ...
      expect('saturate' in result).toBe(false);
    });
    ...
    test('sepia を filter に変換する', () => {
      ...
      expect('sepia' in result).toBe(false);
    });
  });
