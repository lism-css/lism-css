...
[![License: MIT](https://img.shields.io/npm/l/lism-css.svg)](https://github.com/lism-css/core/blob/main/LICENSE)
...
- **Spacing:** `--s5`, `--s10`, `--s15` … `--s45`, `--s50`, `--s60`, `--s70` (mapped to rem values)
