...
/**
 * 許可 bare import を「@lism-css/mock 自身の位置」から解決するための importer パス。
 *
...
export function getResolveAnchor(): string {
  return path.join(getMockPackageRoot(), '__lism-mock-resolve-anchor.js');
}
