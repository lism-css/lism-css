...
const features = [
  {
    icon: Layers,
    title: 'Layout first',
    body: 'Stack, Cluster and Columns describe the skeleton of a screen, so a mock reads like the markup you will ship.',
  },
  {
    icon: Palette,
      ...
      <Group as="section" id="hero" className="p--hero" bgc="canvas" py={['50', null, '70']} hasGutter>
        <Wrapper contentSize="m">
          <Stack g="30" ai="center" ta="center">
            <Badge keycolor="brand">Design mock</Badge>
            <Heading level="1" fz={['3xl', null, '5xl']} hl="xs">
              Ship the layout before the code
            </Heading>
            <Text fz={['m', null, 'l']} c="text-2">
              Sketch every screen with the same primitives and tokens your production app uses, then hand the mock over as the implementation
              baseline.
            </Text>
