...
// Default refs
//
// ブランチに関係なく常に 'main' 固定（dev / main のマージで切り替えない）。
// dev 側の変更を試すときは各コマンドの `--ref` で指定する。運用は documents/cli-guide.md を参照。
// -----------------------------------------------------------------------------
 ...
 */
export const SKILL_NAMES = ['lism-css-guide', 'lism-css-refactor', 'lism-mockup-guide'] as const;
