...
const StarHalf = /* @__PURE__ */ forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(function StarHalf({ children, ...props }, ref) {
  ...
  return (
    ...
    >
      <path
        d="M12,2.25c-.099,0-.199.019-.296.058-.195.08-.35.234-.429.429l-2.308,5.588-5.992.487c-.436.038-.759.423-.721.859.018.206.115.396.272.531l4.566,3.938-1.395,5.882c-.103.423.156.849.579.952.203.049.417.016.595-.092l5.13-3.155V2.25Z"
        fill="currentColor"
        stroke="none"
      />
