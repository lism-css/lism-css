...
| 版 | 内容 | 狙い | 懸念 |
|---|---|---|---|
| **ゼロ版** | Usage 全削除、docs URL リンクのみ | 最軽量 | agent が URL を踏まず自前知識で書く → 非 Lism 流に戻る |
| **最小例版** | 最も基本の 1 例だけ残し応用は URL | 判断文 ＋ 最小例で Lism 流をアンカー（+5 行程度） | フルよりは弱い |
| **フル版（現状）** | Usage を skill 内に全保持 | 最確実 | 最重量 |
