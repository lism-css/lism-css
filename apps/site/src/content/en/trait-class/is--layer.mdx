...
<Preview>
  ...
  <PreviewArea p="15">
    <Frame ar="2/1" pos="relative">
      ...
      <Text pos="absolute" b="0" r="0" p="20" hl="0" c="white" fz="xs" o="p">
        <Fragment>Photo by xxxxxx</Fragment>
      </Text>
    </Frame>
  </PreviewArea>
  <PreviewCode>
...
<Preview>
  ...
  <PreviewArea p="15">
    <Box pos="relative" py="50" px="40">
      <Frame isLayer>
        <Media src="https://cdn.lism-css.com/img/2SvHdIk1KOOR.webp" alt="" width="960" height="640" loading="lazy" decoding="async" />
      </Frame>
      <Layer bgc="black:50%" />
  ...
  <PreviewCode slot="tab" label="HTML">
    ...
    <div class="l--box -pos:relative -py:50 -px:40">
      <div class="l--frame is--layer">
        <img src="https://cdn.lism-css.com/img/2SvHdIk1KOOR.webp" alt="" width="960" height="640" loading="lazy" decoding="async" />
      </div>
