---
title: 'Avatar'
description: 'A UI component that displays avatar images or initials.'
---
...
{/* |`mediaProps`| For any other props you want to pass to the media element, specify them as an object with this prop. | */}
...
<Preview>
  ...
  <PreviewCode slot="tab" label="HTML">
    ...
    <div class="b--avatar l--frame -w -bd -bxsh:20" style="--w: 5rem; --bdw: 2px; --bdc: var(--base)">
      <img src="https://cdn.lism-css.com/img/avatar/of5v8rPFMI8F.webp" alt="Avatar of xxxx" width="100%" height="100%" decoding="async" />
    </div>
    ```
  </PreviewCode>
</Preview>
