---
title: 'Details'
description: 'A UI component that creates collapsible content using the details and summary elements.'
---
...
Unlike [`Accordion`](/en/ui/Accordion/), this component is implemented with CSS only — no JavaScript required.
