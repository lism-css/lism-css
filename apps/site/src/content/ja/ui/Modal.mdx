---
title: 'Modal'
description: 'dialog要素でモーダルを表示するUIコンポーネントです。'
---

import { Menu } from '@lism-css/icons/astro';
...
モーダル内の同一ページへのリンク（`#id`など）をクリックすると、リンク先へ移動しつつモーダルが閉じます。
...
<Preview>
  ...
  <PreviewCode slot="tab" label="JSX">
    ```jsx '"modal-03"'
    import { Menu } from '@lism-css/icons/react';
