---
title: 'Callout'
description: '記事内の重要なポイントを強調表示するUIコンポーネントです。'
---
import { ArrowRight, Note } from '@lism-css/icons/astro';
...
:::note
ソースコード全体は [GitHub](https://github.com/lism-css/lism-css/tree/main/packages/lism-ui/src/components/Callout) で公開しています。
:::
...
<Preview>
  ...
  <PreviewArea p="30">
    <Callout title="Heading text..." icon={ArrowRight} keycolor="pink">
      <DummyText lang="ja" />
    </Callout>
  </PreviewArea>
  <PreviewCode slot="tab" label="JSX">
...
<Preview>
  <PreviewTitle>`title`なし</PreviewTitle>
  <PreviewArea p="30">
    <Callout type="info">
...
<Preview>
  ...
  <PreviewCode slot="tab" label="JSX">
    ```jsx
    import { Note } from '@lism-css/icons/react';
