...
Lism CSS の主体はあくまでも**CSSの設計理論**であり、その設計ルールに沿ってまとめられた**CSSファイル**をコア機能として提供しています。
...
また、`lism-css`というnpmパッケージに内包されている React や Astro 向けの**専用コンポーネント**を使えば、さらに快適な開発体験が得られます。
...
| `lism-cli` | プロジェクトの雛形生成や、UIコンポーネントのコピーができるCLI |
