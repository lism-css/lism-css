 ...
 * - <div class="b--tabs_list">: タブのボタン行（JSX/HTML 等の見出し）。削除
 * - <span class="__decorator">: 装飾要素（残存する場合に備えて）。削除
 *
 * 残りの c--preview / c--preview_code / b--tabs_panel は透明なコンテナとして
...
const DROP_CLASSES = ['c--preview_area', 'c--preview_title', 'c--preview_help', 'b--tabs_list', '__decorator'];
