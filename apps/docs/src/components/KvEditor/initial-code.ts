...
const buildInitialHtml = (lead1: string, lead2: string, urlPrefix: string): string => `<h1 class="-fw:700 -fz:5xl -ta:center">
...
<div class="l--flex -jc:center -ai:center -g:15 -mbs:40">
  <a class="l--flex -ai:center -px:10 -py:10 -c:base -bdrs:20 -fw:500 -td:none -lh:s" href="${urlPrefix}/docs/installation/">
    <span class="-px:10">Get Started</span>
  </a>
  <a class="l--flex -ai:center -g:10 -px:10 -py:10 -bgc:base -bdrs:20 -td:none -lh:s" href="${urlPrefix}/docs/" data-modal-open="search-modal">
