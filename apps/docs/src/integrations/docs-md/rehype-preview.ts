 ...
 * - <span class="__decorator">: PreviewTitle 内の装飾矢印（↓）。削除
 *
 * 残りの c--preview / c--preview_code / c--preview_title / c--tabs_panel は
 * 透明なコンテナとして rehype-remark に任せる（子要素はそのまま出力される）。
 */
import { visit } from 'unist-util-visit';
import type { Root, Element, Parents } from 'hast';
import { hasClass } from './util';

const DROP_CLASSES = ['c--preview_area', 'c--preview_help', 'c--tabs_list', '__decorator'];
