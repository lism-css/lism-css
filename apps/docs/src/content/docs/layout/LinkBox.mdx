...
2. `<LinkBox>`(`.is--linkBox`）を`<div>`にして、内部に`a.is--overlayLink`を配置する。
...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox href='#linkbox-demo01' p='40' bgc='base' bdc='line' bd bdrs='30'>
			...
			<Dummy lh='s' my-s='20' />
			<Text fz='s' c='text-2' ta='r' lh='1' my-s='10'>MORE →</Text>
		</LinkBox>
	</PreviewArea>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<a class="is--linkBox -hov:op -p:40 -bgc:base -bd -bdc:divider -bdrs:30" href="#linkbox-demo01">
			...
			<p class="-fz:s -c:text-2 -ta:r -lh:1 -my-s:10">MORE →</p>
		</a>
		```
	</PreviewCode>
</Preview>
...
### 2. 内部に`is--overlayLink`を配置する

内部のアンカー要素に`.is--overlayLink`を併用してもボックス全体をリンクにすることができます。
...
<Preview>
	...
	<PreviewArea p='30'>
		<LinkBox p='40' bgc='base' bdc='line' bd bdrs='30' hasTransition hov='bxsh'>
			<Text fz='xl' fw='bold'>
				<Link isOverlayLink href='#linkbox-demo02'>Heading link text</Link>
			</Text>
			<Dummy c='text-2' lh='s' my-s='20' />
			<Text id='inner-link02' my-s='10'>
				<a href='#inner-link02' className='-hov:op'>Inner Link</a>
			</Text>
		</LinkBox>
	</PreviewArea>
	<PreviewCode slot='tab' label='JSX'>
		```jsx "isOverlayLink" "is--overlayLink"
		<LinkBox p='40' bgc='base' bdc='line' bd bdrs='30' hasTransition hov='bxsh'>
			<Text fz='xl' fw='bold'>
				<Link isOverlayLink href='#linkbox-demo02'>Heading link text</Link>
			</Text>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx "is--overlayLink"
		<div class="is--linkBox -hov:bxsh -p:40 -bgc:base -bdc:divider -bd -bdrs:30 has--transition">
			...
			<p id="inner-link02" class="-my-s:10" >
				<a href='#inner-link02' class="-hov:op">Inner Link</a>
			</p>
		</div>
		```
	</PreviewCode>
...
`is--overlayLink`でリンクを設置すると、Tabキーでフォーカスした時はアウトラインがボックス全体ではなくリンクテキスト部分のみになります。
...
- `is--overlayLink`のようにリンク要素の擬似要素を広げてボックス全体をクリックできるようにする手法では、altキーを押しながらのリンク内テキスト選択ができなくなるという問題があります。
