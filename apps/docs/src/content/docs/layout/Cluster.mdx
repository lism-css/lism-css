...
import { Box, Cluster, Text, Lism } from 'lism-css/astro';
import { Preview, PreviewArea, PreviewTitle, PreviewCode, ImportPackage, EmbedCode, Callout } from "~/components";

複数の要素を横方向に連続的に並べて配置するレイアウトモジュール


## CSS

<EmbedCode dirPath='packages/lism-css' srcPath='src/scss/layout/_cluster.scss' />
