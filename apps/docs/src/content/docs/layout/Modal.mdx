...
import { Modal, Lism, Link, Grid, Dummy, Text, Flex, Stack, Center, Icon } from 'lism-css/astro';
import {
	ArrowFatDown,
	ArrowRight,
	ShoppingCartSimple,
...
dialog.d--modal#modalID.re--style
    .d--modal_inner
...
<Preview>
	...
	<PreviewArea p='20'>
		<Modal.OpenBtn modalId='modal-03' ai='c' g='5'>
			<Icon icon='menu' fz='xl' /><span>MENU</span>
		</Modal.OpenBtn>

		<Modal.Root id='modal-03' offset='-100px 0'>
			<Modal.Inner max-w='24rem' h='100%' bxsh='40'>
				<Flex bd-b ai='c' jc='between' p='30'>
					<Lism fz='l'>MENU</Lism>
					<Modal.CloseBtn modalId='modal-03' fz='xl' p='5'/>
				</Flex>
				<Modal.Body>
					<Stack className='u--gridBorder' bdc='line' bd-b p='0' ov='clip'>
						<Link href='#menu-link01' className='u--flatLink' hov='o' px='30' py='20'>Menu item 1</Link>
						<Link href='#menu-link02' className='u--flatLink' hov='o' px='30' py='20'>Menu item 2</Link>
						<Link href='#menu-link03' className='u--flatLink' hov='o' px='30' py='20'>Menu item 3</Link>
						<Link href='#menu-link04' className='u--flatLink' hov='o' px='30' py='20'>Menu item 4</Link>
					</Stack>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<Modal.Root id='modal-03' offset='-100px 0'>
			<Modal.Inner max-w='24rem' h='100%' bxsh='40'>
				...
				<Modal.Body>
					<Stack tag='ul' className='u--gridBorder' bdc='line' bd-b p='0' ov='clip'>
						<Lism tag='li'>
							<Link href='#menu-link01' className='u--flatLink' hov='o' px='30' py='20'>Menu item 1</Link>
						</Lism>
						<Lism tag='li'>
