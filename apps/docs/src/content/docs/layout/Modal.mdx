...
<Preview>
	...
	<PreviewArea p='20'>
		<button data-modal-open='modal-01' className='re--style -bd -px:20 -py:5 -bdrs:10 -hov:o'>Open Modal 01</button>
		...
		<Modal.Root id='modal-01' layout={Center} p='40'>
			<Modal.Inner max-w='m' p='40' g='30' bdrs='20' bxsh='40'>
				<Center pos='a' t='0' r='0' z='1' fz='xl' p='20' m='20' bdrs='99'>
					<Modal.CloseIconBtn data-modal-close='modal-01' d='i-f' hov='o'/>
				</Center>
				<Modal.Body isFlow='s'>
					<div className='-fz:xl -fw:bold'>Modal Title</div>
					<Dummy />
					<Dummy length='l' />
					<button data-modal-close='modal-01' className='re--style -bgc:base-2 -lh:xs -p:20 -bdrs:10 -hov:o'>Close Modal</button>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
	</PreviewArea>
...
<Preview>
	<PreviewTitle>`Modal`使用例</PreviewTitle>
	<PreviewArea p='20'>
		<button data-modal-open='modal-02' className='re--style -bd -px:20 -py:5 -bdrs:10 -hov:o'>Open Modal 02</button>
...
<Preview>
	...
	<PreviewArea p='20'>
		<Flex
			...
			className='re--style -ai:c -g:5 -hov:o'
		>
		...
		<Modal.Inner max-w='25rem' w='90%' h='100%' p='40' g='30' bxsh='40'>
			<Modal.Header>
				<Center pos='a' t='0' r='0' z='1' fz='xl' p='20' m='20' bdrs='99'>
					<Modal.CloseIconBtn data-modal-close='modal-03' d='i-f' hov='o' />
				</Center>
