	...
	<PreviewArea p='20'>
		...
		<Modal.Root id='modal-01' layout='stack' jc='center' isContainer='m' p='40'>
			<Modal.Inner pos='relative' p='40' g='30' bdrs='20' bxsh='40'>
				...
				<Modal.Body layout='flow' flowGap='s'>
			...
			<Modal.Inner max-w='24rem' h='100%' bxsh='40'>
				...
				<Modal.Body>
					<Stack className='u--itemDivider' bdc='line' bd-b p='0' ov='clip'>
						<Link href='#menu-link01' className='set--plain' hov='o' px='30' py='20'>Menu item 1</Link>
						<Link href='#menu-link02' className='set--plain' hov='o' px='30' py='20'>Menu item 2</Link>
						<Link href='#menu-link03' className='set--plain' hov='o' px='30' py='20'>Menu item 3</Link>
						<Link href='#menu-link04' className='set--plain' hov='o' px='30' py='20'>Menu item 4</Link>
					</Stack>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<Modal.Root id='modal-03' offset='-100px 0'>
			<Modal.Inner max-w='24rem' h='100%' bxsh='40'>
				...
				<Modal.Body>
					<Stack tag='ul' className='u--itemDivider' bdc='line' bd-b p='0' ov='clip'>
						<Lism tag='li'>
							<Link href='#menu-link01' className='set--plain' hov='o' px='30' py='20'>Menu item 1</Link>
						</Lism>
						<Lism tag='li'>
