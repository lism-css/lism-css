		...
		<Modal.Root id='modal-01' layout={Center} p='40'>
			<Modal.Inner maxW='m' p='40' g='30' bdrs='20' bxsh='40'>
				<Center pos='a' t='0' r='0' z='1' fz='xl' p='20' m='20' bdrs='99'>
					<Modal.CloseIconBtn data-modal-close='modal-01' d='inline-flex' hov='op'/>
				</Center>
				<Modal.Body isFlow='s'>
		...
		<Modal.Root id='modal-02' p='40' ac='c'>
			<Modal.Inner maxW='s' mx='auto' maxH='80%' bdrs='20' bxsh='40'>
				<Flex ai='c' jc='sb' py='20' bd-b>
					...
					<Center p='20' mx='20'>
						<Modal.CloseIconBtn data-modal-close='modal-02' d='inline-flex' fz='xl' />
					</Center>
				</Flex>
...
<Preview>
	...
	<PreviewArea p='20'>
		...
		<Modal.Inner maxW='25rem' w='90%' h='100%' p='40' g='30' bxsh='40'>
			<Modal.Header>
				<Center pos='a' t='0' r='0' z='1' fz='xl' p='20' m='20' bdrs='99'>
					<Modal.CloseIconBtn data-modal-close='modal-03' d='inline-flex' hov='op' />
				</Center>
