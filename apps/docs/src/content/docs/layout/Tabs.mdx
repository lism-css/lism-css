...
<EmbedCode dirPath='packages/lism-css' srcPath='src/components/Tabs/style.scss' />
...
<IconBadge type='help'/> （[`set--hover`](/css/hover#set--hover)の`--isHov_`,`--notHov_`の解説を参考にしてください。）
