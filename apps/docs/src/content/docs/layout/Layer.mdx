...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--box has--gutter -py:50">
			...
			<div class="l--stack -pos:relative -c -g:40" style="--c:var(--white)">
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="l--frame has--gutter -pos:relative -py:50">
			...
			<div class="l--stack -pos:relative -c -g:40" style="--c:#fff">
				<p>Lorem ipsum dolor sit amet...</p>
				<p>Lorem ipsum dolor sit, amet...</p>
			</div>
		 </div>
