...
```pug
details.d--accordion
	summary.d--accordion_header.l--flex.-ai:center
		span.d--accordion_label.-fx:1 ...Header label...
		span.d--accordion_icon.-d:i-f
			svg.l--icon
	div.d--accordion_body.l--grid
		div.d--accordion_inner.-ov:hidden ...Contents...
```
...
<details class="d--accordion -p:20">
	<summary class="d--accordion_header l--flex -ai:center">
		...
		<span class="d--accordion_icon -d:i-f">
	...
	<div class="d--accordion_body l--grid -my-s:20">
		<div class="d--accordion_inner -ov:hidden">
			<p>Lorem ipsum...</p>
		</div>
	</div>
</details>
...
<Preview>
	<PreviewTitle>Preview</PreviewTitle>
	<PreviewArea p='30'>
		<Stack g='30' style={{'--acc-duration': '.2s'}}>
	...
	<PreviewArea>
		<Accordion.Root p='20'>
			<Accordion.Header>
				<Accordion.Label>Accordion.Label</Accordion.Label>
				<Accordion.Icon>
					<Icon hasTransition icon={{as:Plus, weight:'bold'}} />
					<Icon hasTransition icon={{as:Minus, weight:'bold'}} />
				</Accordion.Icon>
			</Accordion.Header>
			<Accordion.Body my-s='20'>
				<Dummy length='l' />
...
<details class="d--accordion -p:20">
	...
	<div class="d--accordion_body l--grid -my-s:20">
		<div class="d--accordion_inner -ov:hidden">...</div>
	</div>
</details>
```
	</PreviewCode>
