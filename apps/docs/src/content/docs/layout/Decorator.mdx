...
<Preview>
	...
	<PreviewArea p='30'>
		<Box p='40' pos='r'>
			<Dummy />
			<Decorator size='1.25em' pos='a' t='0' l='0' bd-x-s bd-y-s />
			<Decorator size='1.25em' pos='a' r='0' b='0' bd-x-e bd-y-e />
		</Box>
	</PreviewArea>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class='l--box -p:40 -pos:r'>
			...
			<div class='l--decorator -pos:a -t:0 -l:0 -bd-x-s -bd-y-s -ar:1/1 -w' style='--w:1.25em' aria-hidden='true'></div>
			<div class='l--decorator -pos:a -r:0 -b:0 -bd-x-e -bd-y-e -ar:1/1 -w' style='--w:1.25em' aria-hidden='true'></div>
		</div>
		```
	</PreviewCode>
</Preview>
