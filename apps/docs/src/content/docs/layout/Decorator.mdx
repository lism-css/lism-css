...
<Preview>
	...
	<PreviewArea p='30'>
		<Box p='40' pos='r'>
			<Dummy />
			<Decorator size='1.25em' pos='a' t='0' l='0' bd-s bd-bs />
			<Decorator size='1.25em' pos='a' r='0' b='0' bd-e bd-be />
		</Box>
	</PreviewArea>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class='l--box -p:40 -pos:relative'>
			...
			<div class='l--decorator -pos:absolute -t:0 -l:0 -bd-s -bd-bs -ar:1/1 -w' style='--w:1.25em' aria-hidden='true'></div>
			<div class='l--decorator -pos:absolute -r:0 -b:0 -bd-e -bd-be -ar:1/1 -w' style='--w:1.25em' aria-hidden='true'></div>
		</div>
		```
	</PreviewCode>
</Preview>
