...
`-fxd:r-r`クラス（`flex-direction:row-reverse`）を併用することで、横並びの時の順番だけを反転させることができます。
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<WithSide fxd='r-r' sideW='10rem' mainW='16rem' g='30'>
			<Box>
				<Dummy />
			</Box>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html "-fxd:r-r"
		<div class='l--withSide -fxd:r-r -g:30' style='--sideW:10rem;--mainW:16rem;'>
			<div class='l--box'>
