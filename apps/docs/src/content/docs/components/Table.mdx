...
<Preview>
	...
	<Frame ov='auto' maxH='20rem'>
		<Table variant='fix1stCell,fixHead' thBgc='base-2' style={{'--bdwwX': '1px'}}>
			<thead>
				<tr>
					<th>Header 1</th>
					<th>Header 2</th>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--frame -ov:a" style="max-height:20rem">
			<table class='c--table c--table--fix1stCell c--table--fixHead' style="--bdwwX:1px;--th--bgc:var(--c-base-2)">
				<thead>...</thead>
				<tbody>...</tbody>
				<tfoot>...</tfoot>
			</table>
