...
<Preview>
	...
	<PreviewArea p='20'>
		<button data-modal-open='modal-01' className='re--style -bd -px:20 -py:5 -bdrs:10 -hov:fade'>Open Modal 01</button>
		...
		<Modal.Root id='modal-01' layout={Center} p='40'>
			<Modal.Inner maxW='m' p='40' g='30' bdrs='20' bxsh='40'>
				...
				<Modal.Body isFlow='s'>
					...
					<Dummy />
					<Dummy length='l' />
					<button data-modal-close='modal-01' className='re--style -bgc:base-2 -lh:xs -p:20 -bdrs:10 -hov:fade'>Close Modal</button>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
	</PreviewArea>
...
<Preview>
	<PreviewTitle>`Modal`使用例</PreviewTitle>
	<PreviewArea p='20'>
		<button data-modal-open='modal-02' className='re--style -bd -px:20 -py:5 -bdrs:10 -hov:fade'>Open Modal 02</button>
