...
<Preview>
	...
	<PreviewArea>
		<Frame tag='figure' ar='2/1' pos='rel'>
			<Media contrast={1.1} saturate={0.2} src='/img/img-2.jpg' alt='' width='960' height='640' />
			<Lism tag='figcaption' pos='abs' z='1' b='0' p='5' w='100%' c='white' ta='center' lts='l'>Lorem ipsum text.</HTML.p>
		</Frame>
	</PreviewArea>
	<PreviewCode slot='tab' label='JSX'>
