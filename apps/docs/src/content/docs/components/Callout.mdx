...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--callout l--withSide u--cbox -p:20 -bd -bdrs:10 -g:20" style="--keycolor:var(--red)">
			<div class="c--callout_icon l--center -c -fz:xl -p:5" data-is-side style='--c:var(--keycolor)'>
...
<ImportSource name='Callout' react astro css='css' others={['presets.js']}/>
