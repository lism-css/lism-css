...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="c--card l--withSide -c:text -bgc:base -bdrs:20 -bxsh:20 -ov:h" style="--sideW:50%">
...
- `<CardMedia>`: `Frame.c--card_media`を呼び出します.
- `<CardBody>`: `Stack.c--card_body`を呼び出します. */}
...
<Preview>
	...
	<PreviewArea resize p='40'>
		<Card isLinkBox hov={{bxsh: '40'}} trs sideW='50%'>
...
<Preview>
	<PreviewTitle>`u--innerR`の活用</PreviewTitle>
	<PreviewArea resize p='30'>
		<Card sideW='45%' className='u--outerR' g='20' p='20' bdrs='30'>
			<Frame data-is-side ar='16/9' className='u--innerR'>
				<Media src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack g='10' p='10'>
				<h3 className='-fz:l'>Card Title</h3>
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx "u--outerR" "u--innerR" "p='20' bdrs='30'"
		<Card sideW='45%' className='u--outerR' g='20' p='20' bdrs='30'>
			<Frame data-is-side ar='16/9' className='u--innerR'>
				<Media src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
...
<Preview>
	...
	<PreviewArea p='30'>
		<Columns variant='liquid' colSize='20rem' g='30'>
			<Card href='#card-a' pos='r' bdrs='20' hov='set'>
				<Frame ar='3/2'>
					<img src='/img/img-1.jpg' alt='' width='960' height='640' />
				</Frame>
			...
			<Card href='#card-b' pos='r' bdrs='20' hov='set'>
				<Frame ar='3/2'>
	...
	<Columns variant='liquid' colSize='20rem' g='30'>
		<Card href='#card-a' pos='r' bdrs='10' hov='set'>
			<Frame ar='3/2'>
				<img src='/img/img-1.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack pos='a' b='0' w='100%' p='20' bgc='white:50%'>
		...
		<Card href='#card-b' pos='r' bdrs='10' hov='set'>
			<Frame ar='3/2'>
				<img src='/img/img-2.jpg' alt='' width='960' height='640' />
			</Frame>
			<Stack pos='a' b='0' w='100%' p='20' bgc='white:50%'>
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Card sideW='50%' sidePosition='start start' bxsh='0' bdrs='0'>
			<Frame data-is-side ar={['16/9', 'unset']} pos='r' bdrs='20'>
