...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Avatar size='5rem' src='/img/avatar01.jpg' alt='Avatar of xxxx' bd bdw='3px' bdc='blue' bxsh='20'/>
	</PreviewArea>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="c--avatar l--frame -ar:1/1 -w -h:a -bdrs:99 -bd -bxsh:20" style="--w:5rem;--bdw:3px;--bdc:var(--blue)">
			<img src="/img/avatar01.jpg" alt="Avatar of xxxx" width="100%" height="100%" decoding="async">
		</div>	
		```
	</PreviewCode>
