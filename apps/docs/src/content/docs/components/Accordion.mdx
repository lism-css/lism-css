...
アコーディオン用のトランジションは`--trsdu--acc`で秒数を管理できます。
...
<PreviewCode slot='tab' label='HTML'>
```html "--trsdu--acc"
<div class="l--stack -g:30" style="--trsdu--acc">
	<summary class="d--accordion__header ...">...</summary>
	<summary class="d--accordion__header ...">...</summary>
</div>
```
...
<details class="d--accordion -p:20">
	<summary class="d--accordion__header l--flex -ai:c">
		...
		<button class="d--accordion__icon -d:ig -bd -bdrs:5 -bgc:inherit -p:10" data-role="trigger">
