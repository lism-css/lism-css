...
<Preview>
	...
	<PreviewArea resize>
		<Stack max-sz='full' min-h='70vh' g='20' c='white' pos='rel'>
			<Frame isLayer>
...
<Preview>
	...
	<PreviewArea resize>
		<Stack max-sz='full' hasGutter pos='rel' min-h='50vh' c='white' g='15'>
			...
			<Flow isContainer='m' py='30' my='auto' z='0'>
	...
	<PreviewArea resize p='20'>
		<Box max-sz='full' style={{ '--slopeH': 'clamp(2.5rem, 1.25rem + 5cqw, 5rem)' }}>
			<Stack max-sz='full' hasGutter pos='rel' min-h='50vh' c='white' g='15'>
				...
				<Flow isContainer='m' py='30' pr={['0', '25%', '33%']} my='auto' z='0'>
					<HTML.p fw='bold' fz='xl'>ShapDivider & Layers</HTML.p>
					<Dummy length='l' />
				</Flow>
				<Spacer h='var(--slopeH)' />
			...
			<Stack max-sz='full' hasGutter pos='rel' min-h='50vh' c='white' my-s='calc(0px - var(--slopeH))'>
				...
				<Spacer h='var(--slopeH)' />
				<Flow isContainer='m' py='30' pl={['0', '25%', '33%']} my='auto' z='0'>
					<HTML.p fw='bold' fz='xl'>ShapDivider & Layers</HTML.p>
					<Dummy length='l' />
				</Flow>
