...
import { Spacer, Box, Flow, Flex, Grid, Media, Dummy, Text, Container, Layer, Stack, Center, Frame } from 'lism-css/astro';
...
<Preview>
	...
	<PreviewArea resize>
		<Stack isFullwide min-h='50vh' bgc='base-2'>
...
<Preview>
	...
	<PreviewArea resize>
		<Stack isFullwide min-h='70vh' g='30' c='white' pos='rel'>
			<Frame isLayer>
...
<Preview>
	...
	<PreviewArea resize>
		<Stack isFullwide hasGutter pos='rel' min-h='50vh' c='white' g='20'>
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Box isFullwide style={{ '--slopeH': 'clamp(2.5rem, 1.25rem + 5cqw, 5rem)' }}>
			...
			<Stack isFullwide hasGutter pos='rel' min-h='50vh' c='white' my-s='calc(0px - var(--slopeH))'>
				<Frame
					isLayer
					style={{
