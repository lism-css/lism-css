...
<Preview>
	...
	<PreviewArea resize isFlow={false}>
		<Stack g='40'>
...
<Preview>
	...
	<PreviewArea resize p='5' isFlow={false}>
		<Container size='m' hasGutter py='50' bgc='text' c='base'>
			<Dummy />
		</Container>
...
<Preview>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<Container pos='r'>
			...
			<Container size='m' hasGutter py='50' c='white'>
				<Dummy length='xl' />
			</Container>
			<ShapeDivider viewBox='0 0 100 10' isAnimation c='base' level='7'>
				<path opacity='.3' d='M100,5.5C91.5,3,79.5,7.5,71.5,8C58,9,49,0.5,36,2c-9,1-13.5,3.5-20.5,3.5C8.5,6,0,2,0,2v8h100V5.5z'></path>
...
<Preview>
	...
	<PreviewArea resize p='5' isFlow={false}>
		...
		<Container pos='r' hasGutter c='base' bgc='text'>
