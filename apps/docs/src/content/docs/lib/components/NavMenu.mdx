...
<Preview>
	...
	<PreviewArea p='20'>
		<Box min-h="15rem">
			<NavMenu.Root fxd='row' lh='s' itemP='10 10'>
				<NavMenu.Item hov='c'>
					<NavMenu.Link href='#menu1'>Menu item</NavMenu.Link>
				</NavMenu.Item>
				...
				<NavMenu.Item pos='rel'>
					<Accordion.Root>
						<Accordion.Header g='0' pr='10'>
							<Accordion.Label>
								<NavMenu.Link href='###' pr='10' hov='c'>Icon trigger Menu</NavMenu.Link>
							</Accordion.Label>
							<Accordion.Icon isTrigger bd bdc='cc' bgc='inherit' p='5' bdrs='5' hov='c'/>
						</Accordion.Header>
						<Accordion.Body pos='abs' bxsh='20' bgc='base' w='100%'>
							<NavMenu.Nest fz='s' px-s='0'>
								<NavMenu.Item hov='bgc'>
