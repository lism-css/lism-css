...
<Preview>
	...
	<PreviewArea p='40'>
		<NavMenu.Root>
			<NavMenu.Item>
				<NavMenu.Link href='#menu1' g='20' ai='center' bgc="text" c="base" hov='neutral'>
					<span>Menu item</span>
			...
			<NavMenu.Item>
				<NavMenu.Link href='#menu2' g='20' ai='center' bgc="text" c="base" hov='neutral'>
					<span>Menu item</span>
					<Icon icon='caret-right' mx-s='auto' />
				</NavMenu.Link>
			</NavMenu.Item>
			<NavMenu.Item>
				<NavMenu.Link href='#menu3' g='20' ai='center' bgc="text" c="base" hov='neutral'>
					<span>Menu item</span>
					<Icon icon='caret-right' mx-s='auto' />
				</NavMenu.Link>
			</NavMenu.Item>
...
<Preview>
	...
	<PreviewArea p='40'>
		<NavMenu.Root bd bdc='line' itemP='40'>
...
<Preview>
	...
	<PreviewArea p='30'>
		<NavMenu.Root bd-y bdc='line' hovBgc='base-2'>
			<NavMenu.Item>
...
<Preview>
	...
	<PreviewArea p='30'>
		<Box min-h="15rem">
		<NavMenu.Root fxd='row' lh='s' itemP='20 30'>
			<NavMenu.Item hov='o'>
				<NavMenu.Link href='#menu1'>Menu item</NavMenu.Link>
			</NavMenu.Item>
	...
	<PreviewArea p='30'>
		...
		<NavMenu.Root fxd='row' lh='s' itemP='20 30'>
			...
			<NavMenu.Item pos='rel'>
				<Accordion.Root>
					<Accordion.Header p='var(--_item-p)' hov='o'>
			...
			<NavMenu.Item pos='rel'>
				<Accordion.Root>
					<Accordion.Header g='0' pr='20'>
						<Accordion.Label>
							<NavMenu.Link href='###' pr='20' hov='c'>Icon trigger Menu</NavMenu.Link>
						</Accordion.Label>
						<Accordion.Icon isTrigger bd bgc='inherit' p='10' hov='o'/>
					</Accordion.Header>
					<Accordion.Body pos='abs' bxsh='20' bgc='base' w='100%'>
						<NavMenu.Nest px-s='0'>
							<NavMenu.Item hov='bgc'>
