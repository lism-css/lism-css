...
<Preview>
	...
	<PreviewArea p='10'>
		<Flex className='set--scrollSnap' ov='auto' g='30' bdrs='20'>
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Flex className='set--scrollSnap' ov='auto' bgc='black' p='30' g='30' bdrs='30' style={{ 'scroll-padding': 'var(--p)' }}>
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Flex className='set--scrollSnap' ov='auto' g='30' p='20' bgc='black' bdrs='20' style={{ '--snap-align': 'center' }}>
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Grid className='set--scrollSnap' ov='auto' gaf='column' gac='100%' g='30' bdrs='20' tabIndex='0'>
...
<Preview>
	<PreviewTitle>Preview<SwipeHelp /></PreviewTitle>
	<PreviewArea resize p='10'>
		<Grid className='set--scrollSnap' ov='auto' gaf='column' gac='var(--cols)' cols={['70%', '40%']} g='20' bdrs='20' tabIndex='0'>
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Grid className='set--scrollSnap' gaf='column' gac='24rem' g='30'>
			<Box bgc='base-2' p='40'>
				<Dummy />
			</Box>
			<Box bgc='text' c='base' p='40'>
				<Dummy length='s'/>
			</Box>
			<Box bgc='base-2' p='40'>
				<Dummy length='xs' />
...
<Preview>
	...
	<PreviewArea p='30 20' isFlow={null}>
		<Grid className='set--scrollSnap' ov='auto' gaf='column' gac='75%' g='20' bdrs='20' style={{ '--snap-align': 'center', 'scroll-behavior': 'smooth' }}>
			<Frame id='image-1' ar='16/9' bdrs='20'><img src='/img/img-1.jpg' alt='' /></Frame>
			<Frame id='image-2' ar='16/9' bdrs='20'><img src='/img/img-2.jpg' alt='' /></Frame>
			<Frame id='image-3' ar='16/9' bdrs='20'><img src='/img/img-3.jpg' alt='' /></Frame>
			<Frame id='image-4' ar='16/9' bdrs='20'><img src='/img/img-4.jpg' alt='' /></Frame>
			<Frame id='image-5' ar='16/9' bdrs='20'><img src='/img/img-5.jpg' alt='' /></Frame>
		</Grid>
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Grid className='set--scrollSnap' ov='auto' g='20' gaf={['column', null, 'row']} gac='75%' gtc={[null, null, 'repeat(2, 1fr)']}>
			<ReelImages />
		</Grid>
	</PreviewArea>
	<PreviewCode>
...
<Preview>
	<PreviewTitle>Preview<SwipeHelp icon={MouseScrollIconu} /></PreviewTitle>
	<PreviewArea resize p='10'>
		<Box max-w='24rem' mx='auto'>
			<Box class='set--scrollSnap' ov='auto' ar='3/4' bdrs='20' bgc='black'>
				<Frame ar='3/4'>
					<img src='/img/v-img-1.jpg' alt=''/>
				</Frame>
				<Frame ar='3/4'>
					<img src='/img/v-img-2.jpg' alt=''/>
				</Frame>
				<Frame ar='3/4'>
					<img src='/img/v-img-3.jpg' alt=''/>
				</Frame>
				<Frame ar='3/4'>
					<img src='/img/v-img-4.jpg' alt=''/>
				</Frame>
			</Box> 
		</Box>
	</PreviewArea>
