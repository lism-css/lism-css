...
<Preview>
	...
	<PreviewArea p='20' isFlow={null}>
		...
		<Flex g='20' jc='c' lh='1' my-s='20'>
			<Lism tag='a' href='#image-1' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>1</Lism>
			<Lism tag='a' href='#image-2' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>2</Lism>
			<Lism tag='a' href='#image-3' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>3</Lism>
			<Lism tag='a' href='#image-4' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>4</Lism>
			<Lism tag='a' href='#image-5' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>5</Lism>
			<Lism tag='a' href='#image-6' c='inherit' bgc='base-2' w='2em' h='2em' ta='c' ac='c' bdrs='10' td='none' hov='op'>6</Lism>
		</Flex>
	</PreviewArea>
	<PreviewCode>
		```jsx "image-1"
