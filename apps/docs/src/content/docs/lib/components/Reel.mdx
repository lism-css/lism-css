...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--reel l--grid -ov:auto -g:20 -gaf:c -gac" style="--gac:20rem" tabindex="0">
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--reel l--grid -ov:auto -g:20 -gaf:c -gac -gac_sm" style="--gac:75%;--gac_sm:45%" tabindex="0">
			<img src="..." alt="" width="960" height="640" />
			<img src="..." alt="" width="960" height="640" />
			...
		</div>
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx "--scSnapAlign"
		<div class="c--reel l--grid -ov:auto -g:20 -gaf:c -gac" style="--scSnapAlign:center;--gac:40%" tabindex="0">
			<img src="..." alt="" width="960" height="640" />
			<img src="..." alt="" width="960" height="640" />
			...
		</div>
...
<Preview>
	...
	<PreviewArea p='20' isFlow={null}>
		...
		<Flex g='20' jc='c' lh='1' my-s='20'>
			<Lism tag='a' href='#image-1' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>1</Lism>
			<Lism tag='a' href='#image-2' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>2</Lism>
			<Lism tag='a' href='#image-3' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>3</Lism>
			<Lism tag='a' href='#image-4' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>4</Lism>
			<Lism tag='a' href='#image-5' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>5</Lism>
			<Lism tag='a' href='#image-6' c='inherit' bgc='base-2' w='2em' h='2em' ta='center' ac='c' bdrs='10' td='none' hov='o'>6</Lism>
		</Flex>
	</PreviewArea>
	<PreviewCode>
		```jsx "image-1"
