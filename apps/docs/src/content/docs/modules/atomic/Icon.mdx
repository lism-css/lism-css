...
import {phIcons, logoIcons} from 'lism-css/components/atomic/Icon/presets';

export const PresetIcons = ({icons}) => {
	return <Grid variant='liquid' cols='10rem' g='20'>
			{Object.keys(icons).map((iconName) => {
				return (
					<Stack key={iconName} g='10' ai='center' bgc='base-2' bdrs='10' p='20'>
...
`<Icon>`で （[`hasMask`(`.shas--mask`)](/css/module-class/#has--mask)  を使う例を紹介します。
...
```css
.a--icon--inline {
	--_scale: 1.125; /* アイコンは小さくなりがちなので、デフォルトでほんのり拡大 */
	vertical-align: -0.125em; /* テキストの下部付近に揃える */
	margin-inline: calc(1em * (var(--_scale) - 1) / 2); /* scaleを考慮し、マージンを確保 */
}
```
...
<Preview>
	...
	<PreviewArea p='30'>
		<p><Icon variant='inline' as={Horse} /> Horse, and Cat <Icon variant='inline' as={Cat}/>.</p>
		<p><Icon variant='inline' icon={{as:WarningCircle, weight:'fill'}} c='red' fz='xl' /> Lorem ipsum dolor sit amet.</p>
	</PreviewArea>
	<PreviewCode>
		```jsx "variant='inline'"
		<p>
			<Icon variant='inline' as={Horse} /> Horse, and Cat <Icon variant='inline' as={Cat}/>.
		</p>
		<p>
			<Icon variant='inline' icon={{as:WarningCircle, weight:'fill'}} c='red' fz='xl' /> Lorem ipsum dolor sit amet.
		</p>
		```
	</PreviewCode>
</Preview>
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--flex -g:20">
			<span class="a--icon -fz:2xl -lh:1" aria-hidden="true">✍️</span>
			<span class="a--icon -fz:2xl -lh:1" aria-hidden="true">💡</span>
		</div>
		```
	</PreviewCode>
</Preview> */}
