...
|（`<Modal.Inner>`） `offset`(`--offset`)| `__inner`のの非表示時の位置をずらすためのオフセット値|
...
<Preview>
	...
	<PreviewArea p='30'>
		...
		<Modal.Root id='modal-01' isContainer='m' p='30'>
...
<Preview>
	...
	<PreviewArea p='30'>
		...
		<Modal.Root id='modal-02' isContainer='s' px='30' py='50'>
		...
		<Modal.Root id='modal-03'>
			<Modal.Inner layout='stack' max-w='24rem' h='100%' bxsh='40' offset='-100px 0'>
				...
				<Modal.Body ov-y='auto'>
					<Stack className='u-itemDivider' bd-b p='0' ov='clip'>
