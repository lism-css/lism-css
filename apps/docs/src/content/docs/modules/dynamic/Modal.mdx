...
<EmbedCode dirPath='packages/lism-css' srcPath='src/scss/modules/dynamic/_modal.scss' />
...
|（`<Modal.Inner>`） `layout`| `__inner`のレイアウト用コンポーネントを指定できます。|
|（`<Modal.Inner>`） `translate`(`--translate`)| `__inner`のの非表示時の位置をずらすためのオフセット値|
| (`<Modal.OpenBtn>`) `modalId`| `data-modal-open`として出力されます。モーダルを開くトリガー要素にて、モーダルの`id`を指定します。|
| (`<Modal.CloseBtn>`) `modalId`| `data-modal-close`として出力されます。モーダルを閉じるトリガー要素にて、モーダルの`id`を指定します。|


## Usage


- Modalは`dialog`を使用しています。自体のdisplay値を変更しないように注意してください。
...
<Preview>
	...
	<PreviewArea p='40'>
		...
		<Modal.Root id='modal-01' isContainer='m' p='40'>
			<Modal.Inner layout='stack' pos='relative' p='40' bdrs='20' bxsh='40'>
				<Modal.CloseBtn modalId='modal-01' autofocus pos='absolute' t='0' r='0' z='1' fz='xl' p='10' m='20' />
				<Modal.Body layout='stack' g='40' className='u-trimItems'>
...
<Preview>
	...
	<PreviewArea p='40'>
		...
		<Modal.Root id='modal-02' isContainer='s' px='40' py='60'>
			<Modal.Inner layout='stack' max-h='100%' bdrs='20' bxsh='40'>
				<Flex ai='center' jc='between' py='20' bd-b>
					...
					<Modal.CloseBtn modalId='modal-02' autofocus fz='xl' p='20' mx='20'/>
				</Flex>
				<Modal.Body layout='flow' px='40' py='30' ov-y='auto'>
					<Dummy />
				...
				<Flex jc='end' px='40' py='30' bd-t>
					<Modal.CloseBtn modalId='modal-02' bgc='text' c='base' lh='s' px='20' py='10' bd='none' bdrs='10'>Close</Modal.CloseBtn>
				</Flex>
			</Modal.Inner>
		</Modal.Root>
	</PreviewArea>
...
<Preview>
	...
	<PreviewArea p='40'>
		...
		<Modal.Root id='modal-03'>
			<Modal.Inner layout='stack' max-w='24rem' h='100%' bxsh='40' translate='-100px 0'>
				...
				<Modal.Body ov-y='auto'>
					<Stack className='u-itemDivider' bdc='line' bd-b p='0' ov='clip'>
						<HTML.a href='#menu-link01' className='set-plain' hov='o' px='40' py='30'>Menu item 1</HTML.a>
						<HTML.a href='#menu-link02' className='set-plain' hov='o' px='40' py='30'>Menu item 2</HTML.a>
						<HTML.a href='#menu-link03' className='set-plain' hov='o' px='40' py='30'>Menu item 3</HTML.a>
						<HTML.a href='#menu-link04' className='set-plain' hov='o' px='40' py='30'>Menu item 4</HTML.a>
					</Stack>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
