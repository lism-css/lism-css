...
<Preview>
	...
	<PreviewArea p='20'>
		<LinkBox href='#linkbox-demo01' p='30' bgc='base' bdc='line' bd bdrs='30' hov='o'>
...
<Preview>
	...
	<PreviewArea p='20'>
		<LinkBox tag='section' p='30' bgc='base' bdc='line' bd bdrs='30' setTransition hov='bxsh'>
	...
	<PreviewCode slot='tab' label='JSX'>
		...
		<LinkBox p='30' bgc='base' bdc='line' bd bdrs='30' setTransition hov='bxsh'>
			<HTML.div fz='xl' fw='bold'>
				<HTML.a className='u-expandedLink' href='#linkbox-demo02'>Heading link text</HTML.a>
			</HTML.div>
			<Dummy c='text-2' lh='s' my-s='15' />
