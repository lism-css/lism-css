...
<Preview>
	...
	<PreviewArea resize p='15'>
		<Grid gtc={['2fr 3fr', '1fr 2fr']} className='u-itemDivider' bd>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class='l--grid u-itemDivider -gtc -gtc_sm -bd' style='--gtc:2fr 3fr;--gtc_sm:1fr 2fr'>
...
<Preview>
	...
	<PreviewArea p='20' resize>
		<Grid gtc={['auto','auto 1fr']} bd-b>
			<Grid gtc='subgrid' gc='1/-1' g='20' ai='center' bd-t py='30' px='10'>
				<Grid gtc={['auto auto', '1fr 1fr']} g='20' jc='start' ai='center'>
					<Lism fz='s'>2024.05.31</Lism>
					<Lism d='in-flex' jc='center' bd fz='xs' lh='s' bgc='text' c='base' py='10' px='15' bdrs='5'>NEWS</Lism>
				</Grid>
			...
			<Grid gtc='subgrid' gc='1/-1' g='20' ai='center' bd-t py='30' px='10'>
				<Grid gtc={['auto auto', '1fr 1fr']} g='20' jc='start' ai='center'>
					...
					<Lism d='in-flex' jc='center' bd fz='xs' lh='s' bgc='text' c='base' py='10' px='15' bdrs='5'>TIPS</Lism>
				</Grid>
			...
			<Grid gtc='subgrid' gc='1/-1' g='20' ai='center' bd-t py='30' px='10'>
				<Grid gtc={['auto auto', '1fr 1fr']} g='20' jc='start' ai='center'>
					...
					<Lism d='in-flex' jc='center' bd fz='xs' lh='s' bgc='text' c='base' py='10' px='15' bdrs='5'>COLUMN</Lism>
				</Grid>
...
<Preview>
	...
	<PreviewArea resize p='15'>
		<Grid gtc='liquid' g='15' cols='12rem'>
			<Box bxsh='20' p='20'><Dummy length='s' /></Box>
			<Box bxsh='20' p='20'><Dummy length='s' /></Box>
			<Box bxsh='20' p='20'><Dummy /></Box>
			<Box bxsh='20' p='20'><Dummy offset='1' /></Box>
