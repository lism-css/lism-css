...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Stack className='u-trimItems' bd g='40' p='40' bdrs='10' max-sz='s'>
	...
	<PreviewCode slot="tab" label="HTML">
		```html
		<div class='u-trimItems l--stack -bd -g:40 -p:40 -bdrs:10'>
	...
	<PreviewCode slot="tab" label='JSX'>
		```jsx
		<Stack className='u-trimItems' bd g='40' p='40' bdrs='10'>
			<Media ar='og' src='https://cdn.lism-css.com/img/a-1.jpg'/>
