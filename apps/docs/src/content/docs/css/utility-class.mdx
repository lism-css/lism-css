...
<Preview>
	<PreviewTitle>例</PreviewTitle>
	<PreviewArea resize p='20'>
		<Grid layout='liquidGrid' className='u-collapseGrid' cols='12rem' bdrs='20'>
...
<Preview>
	...
	<PreviewArea resize p='20'>
		<Grid layout='liquidGrid' className='u-collapseGrid' cols='12rem' p='0' ov='clip'>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
	...
	<PreviewCode>
		```jsx
		<Grid layout='liquidGrid' className='u-collapseGrid' cols='12rem'>
			<Box p='15'><Dummy /></Box>
			<Box p='15'><Dummy /></Box>
			<Box p='15'><Dummy /></Box>
			<Box p='15'><Dummy /></Box>
...
<Preview>
	...
	<PreviewArea resize p='20'>
		<Grid layout='liquidGrid' className='u-collapseGrid' cols='10rem' ov='clip' p='0' bd>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
			<Box p='15'>Grid Item</Box>
