...
<Preview>
	...
	<PreviewArea resize p='5'>
		<Box pos='r' ar='3/2' lh='1'>
			...
			<Box pos='a' l='50%' t='0' translate='-50X' bd p='20'>B</Box>
			<Box pos='a' r='0' t='0' bd p='20'>C</Box>
			<Box pos='a' l='0' t='50%' translate='-50Y' bd p='20'>D</Box>
			<Box pos='a' l='50%' t='50%' translate='-50XY' bd p='20'>E</Box>
			<Box pos='a' r='0' t='50%' translate='-50Y' bd p='20'>F</Box>
			<Box pos='a' l='0' b='0' bd p='20'>G</Box>
			<Box pos='a' l='50%' b='0' translate='-50X' bd p='20'>H</Box>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--box -pos:r -ar:3/2 -lh:1">
			...
			<div class="l--box -pos:a -l:50% -t:0 -translate:-50X -bd -p:20">B</div>
			<div class="l--box -pos:a -r:0 -t:0 -bd -p:20">C</div>
			<div class="l--box -pos:a -l:0 -t:50% -translate:-50Y -bd -p:20">D</div>
			<div class="l--box -pos:a -l:50% -t:50% -translate:-50XY -bd -p:20">E</div>
			<div class="l--box -pos:a -r:0 -t:50% -translate:-50Y -bd -p:20">F</div>
			<div class="l--box -pos:a -l:0 -b:0 -bd -p:20">G</div>
			<div class="l--box -pos:a -l:50% -b:0 -translate:-50X -bd -p:20">H</div>
