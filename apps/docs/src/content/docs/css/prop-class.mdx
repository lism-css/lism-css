...
sidebar:
  order: 7
---
import { Lism, Text, Frame, Layer, Media, Dummy, Box, Flex, Grid, Center, Columns } from "lism-css/astro";
...
|`inline-size`|`isz`||-|
|`block-size`|`bsz`||-|
|`max-inline-size`|`maxIsz`||-|
|`max-block-size`|`maxBsz`||-|
|`min-inline-size`|`minIsz`||-|
|`min-block-size`|`minBsz`||-|
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```html
		<div class="l--box -pos:relative -ar:3/2 -lh:1">
			<div class="l--box -pos:absolute -l:0 -t:0 -bd -p:20">A</div>
			<div class="l--box -pos:absolute -l:50% -t:0 -trnslt:-50X -bd -p:20">B</div>
			<div class="l--box -pos:absolute -r:0 -t:0 -bd -p:20">C</div>
			<div class="l--box -pos:absolute -l:0 -t:50% -trnslt:-50Y -bd -p:20">D</div>
			<div class="l--box -pos:absolute -l:50% -t:50% -trnslt:-50XY -bd -p:20">E</div>
			<div class="l--box -pos:absolute -r:0 -t:50% -trnslt:-50Y -bd -p:20">F</div>
			<div class="l--box -pos:absolute -l:0 -b:0 -bd -p:20">G</div>
			<div class="l--box -pos:absolute -l:50% -b:0 -trnslt:-50X -bd -p:20">H</div>
			<div class="l--box -pos:absolute -r:0 -b:0 -bd -p:20">I</div>
		</div>
		```
	</PreviewCode>
</Preview>
