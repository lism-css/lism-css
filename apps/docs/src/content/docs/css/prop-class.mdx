...
|---|---|---|---|
|`font`|`f`|`inherit`|-|
|`font-size`|`fz`|[`TYPE.FZ`](/css/tokens/#typofz)|○|
|`font-family`|`ff`|[`TYPE.FF`](/css/tokens/#typoff)|-|
|`font-weight`|`fw`|[`TYPE.FW`](/css/tokens/#typofw)|-|
|`font-style`|`fs`|`italic`|-|
|`line-height`|`lh`|[`TYPE.LH`](/css/tokens/#typolh), <br/>`1`|-|
|`letter-spacing`|`lts`|[`TYPE.LTS`](/css/tokens/#typolts)|-|
...
<Preview>
	<PreviewTitle>Examples</PreviewTitle>
	<PreviewArea p='30'>
		<HTML.p c='main' bgc='base-2' bd bdc='line' p='40'>Example text</HTML.p>
	</PreviewArea>
	<PreviewCode slot="tab" label="HTML">
	```html
...
<Preview>
	...
	<PreviewArea p='30' resize>
		<Lism p={['20', '30']} bd>
			...
			<HTML.p my-s='20' mx='40'>Example text</HTML.p>
		</Lism>
	</PreviewArea>
	<PreviewCode slot="tab" label="HTML">
	```html
