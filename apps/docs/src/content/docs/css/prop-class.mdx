...
<Preview>
	...
	<PreviewArea p='30' resize>
		<Columns g='20'>
			...
			<Frame ar='16/9' bgi='url(/img/pattern.png)' bgp='center' bgsz='4rem' bgbm='difference' bgc='white'></Frame>
		</Columns>
	</PreviewArea>
...
<Preview>
	...
	<PreviewArea p='30'>
		<Center>
			<Box bg='linear-gradient(45deg, var(--blue), var(--pink))' bgcp='text'>
