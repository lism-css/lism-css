...
<Preview>
	...
	<PreviewArea p='40'>
		<LinkBox href='###' trs hov={{ bdc:'red' }} bd bdw='3px' bgc='base-2' p='30' style={{'--trsdu':'1s'}}>
			<p>LinkBox</p>
			<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
		</LinkBox>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html "-trs" "--trsdu:1s"
		<a
			class="is--linkBox -hov:bdc -trs -bd -bgc:base-2 -p:30"
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx "trs" "--trsdu"
		<LinkBox
			href='###' trs hov={{ bdc:'red' }} bd bdw='3px' bgc='base-2' p='30'
			style={{'--trsdu':'1s'}}~
		>
			<p>LinkBox</p>
			<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
