...
<Preview>
	...
	<PreviewArea p='30'>
		<Frame isLinkBox setHov href='#banner-link' ar='16/9' bdrs='30'>
			...
			<Layer setTransition hov='to:show' bgc='rgb(0 0 0 / 40%)' blur='6px'>
				<Center h='100%' c='#fff'>
					<HTML.span fz='2xl' fs='italic' fw='light' lts='l' bdrs='99' px='30' py='10'>View More</HTML.span>
				</Center>
			</Layer>
		</Frame>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		...
		<a class="l--frame is--linkBox set-hov -ar:16/9 -bdrs:30" href="#banner-link">
			<img class="a--media is--layer" src="/img/img-1.jpg" width="960" height="640" loading="lazy">
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		>
			<div class="l--frame is--layer">
				<img class="a--media is--layer set-transition -hov:to:zoom" src="/img/img-2.jpg" width="960" height="640" loading="lazy" />
			</div>
