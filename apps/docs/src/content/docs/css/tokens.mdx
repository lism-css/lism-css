...
:root{
	...
	--bxsh--10: var(--sh-sz--0) var(--sh-color), var(--sh-sz--1) var(--sh-color);
	--bxsh--20: var(--sh-sz--1) var(--sh-color), var(--sh-sz--2) var(--sh-color);
	--bxsh--30: var(--sh-sz--2) var(--sh-color), var(--sh-sz--3) var(--sh-color);
	--bxsh--40: var(--sh-sz--3) var(--sh-color), var(--sh-sz--4) var(--sh-color);
	--bxsh--50: var(--sh-sz--4) var(--sh-color), var(--sh-sz--5) var(--sh-color);

	--bxsh--i10: inset var(--sh-sz--0) var(--sh-color), inset var(--sh-sz--1) var(--sh-color);
	--bxsh--i20: inset var(--sh-sz--1) var(--sh-color), inset var(--sh-sz--2) var(--sh-color);
}
