...
export const ColorBadge = ({color, label}) => {
	return <span className='-d:f -ai:center -g:10'>
			<Lism tag='span' w='1.5em' ar='1/1' bgc={color} bdrs='10' bxsh='10' />
...
<Preview>
	...
	<PreviewArea p={20} flowGap='s' resize>
		<SpacingDemos spaces={[
...
<Tabs.Root variant='line' g='30'>
	...
	<Tabs.Panel>
		...
		<PreviewArea p='20' className='fzDemo set--fz' style={{'--_fzmol':7}}>
			<FzDemos />
		</PreviewArea>
		</Tabs.Panel>
	</Tabs.Item>
	...
	<Tabs.Panel>
		...
		<PreviewArea p='20' className='fzDemo set--fz' style={{'--_fzmol':8}}>
			<FzDemos />
		</PreviewArea>
		</Tabs.Panel>
	</Tabs.Item>
	...
	<Tabs.Panel>
		...
		<PreviewArea p='20' className='fzDemo set--fz' style={{'--_fzmol':9}}>
			<FzDemos />
		</PreviewArea>
		</Tabs.Panel>
	</Tabs.Item>
...
|トークン値|変数|クラス|初期値|
|---|---|---|---|
|`ghost`|`--o--ghost`|`-o:ghost`|`0.125`|
|`pale`|`--o--pale`|`-o:pale`|`0.25`|
|`soft`|`--o--soft`|`-o:soft`|`0.5`|
|`mild`|`--o--mild`|`-o:mild`|`0.75`|
{/* |`solid`|`--o--solid`|`-o:solid`|`0.9`| */}

opacityは数値として見た場合と"どれだけ薄めるか"で見た場合では逆の感覚になる（低い→強い、高い→弱い）ため、"質感"の表現でトークンを考えました。

`0.9`などにもう１段階トークンを追加するとしたら、`solid`などの固めの表現にすると統一感が出ると思います。


<Preview>
	<PreviewTitle>Preview</PreviewTitle>
	<PreviewArea p='50'>
		<Dummy o='ghost' pre='ghost: ' />
		<Dummy o='pale' pre='pale: ' />
		<Dummy o='soft' pre='soft: ' />
		<Dummy o='mild' pre='mild: ' />
		{/* <Dummy o='solid' pre='solid: ' /> */}
		<Dummy pre='1: '/>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<p class="-o:ghost">Lorem ipsum ...</p>
		<p class="-o:pale">Lorem ipsum ...</p>
		<p class="-o:soft">Lorem ipsum ...</p>
		<p class="-o:mild">Lorem ipsum ...</p>
		<p>Lorem ipsum ...</p>
		```
	</PreviewCode>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
		<Text o='ghost'>Lorem ipsum ...</Text>
		<Text o='pale'>Lorem ipsum ...</Text>
		<Text o='soft'>Lorem ipsum ...</Text>
		<Text o='mild'>Lorem ipsum ...</Text>
		```
	</PreviewCode>
</Preview>
