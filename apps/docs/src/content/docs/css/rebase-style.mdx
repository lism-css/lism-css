...
<Preview>
	...
	<PreviewArea p='40' nogrid>
		<Stack g='30'>
			...
			<Flex className='re--shadow -g:40' px-s='20' style={{'--_sh_hsl': '200 50% 50%', '--_sh_a':'20%'}}>
				<Box bxsh='20' p='40' bdrs='20'>Box</Box>
				<Box bxsh='40' p='40' bdrs='20'>Box</Box>
			</Flex>
		</Stack>
		...
		<PreviewCode slot='tab' label='HTML'>
		```html "re--shadow"
		<div class="re--shadow l--flex -g:40" style="--_sh_hsl:200 50% 50%;--_sh_a:20%">
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx "re--shadow"
		<Flex className='re--shadow' g='40' style={{'--_sh_hsl': '200 50% 50%', '--_sh_a':'20%'}}>
			<Box bxsh='20' p='40' bdrs='20'>Box</Box>
			<Box bxsh='40' p='40' bdrs='20'>Box</Box>
		</Flex>
		```
