...
<Preview>
	...
	<PreviewArea p='40' nogrid>
		<Stack g='30'>
			...
			<Flex className='re--sh -g:40 -pis:30' style={{'--_sh_hsl': '200 50% 50%', '--_sh_a':'20%'}}>
				<Box bxsh='20' p='40' bdrs='20'>Box</Box>
				<Box bxsh='40' p='40' bdrs='20'>Box</Box>
			</Flex>
		</Stack>
		...
		<PreviewCode slot='tab' label='HTML'>
		```html "re--sh"
		<div class="re--sh l--flex -g:40" style="--_sh_hsl:200 50% 50%;--_sh_a:20%">
	...
	<PreviewCode slot='tab' label='JSX'>
		```jsx "re--sh"
		<Flex className='re--sh' g='40' style={{'--_sh_hsl': '200 50% 50%', '--_sh_a':'20%'}}>
			<Box bxsh='20' p='40' bdrs='20'>Box</Box>
			<Box bxsh='40' p='40' bdrs='20'>Box</Box>
		</Flex>
		```
