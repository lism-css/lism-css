...
**独自のCSS設計理論をゼロから構築**しており、以下のようなコンセプトになっています。
...
※ [Every Layout](https://every-layout.dev/) + [Bootstrap](https://getbootstrap.com/) + [Tailwind CSS](https://tailwindcss.com/) を 混ぜ合わせたようなイメージで設計しました。


<Callout keycolor="green" icon='good'>
Lism CSSを元にした**コンポーネント集** をnpmパッケージとして提供しており、ReactとAstroではより手軽に利用できます。
</Callout>
