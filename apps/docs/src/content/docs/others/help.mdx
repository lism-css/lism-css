...
そのような場合は、原因となる要素に`.-ovwrap:any`（`overflow-wrap: anywhere` のユーティリティクラス）を付けてください。
...
<Preview>
	...
	<PreviewArea resize p='30'>
		<Flex g='15' className='has--itemGuide'>
...
<Preview>
	...
	<div class="l--flex -g:15">
		<p class="-ovwrap:any">LooooooooooooongStriiiinnnnnnnnnnngs!!!!</p>
		<p>AAA</p>
		<p>BBB</p>
		<p>CCC</p>
	</div>
