...
.-bxsh\:2 {
	box-shadow: var(--bxsh--2);
}
.-bxsh\:3 {
	box-shadow: var(--bxsh--3);
}
.-bxsh\:4 {
	box-shadow: var(--bxsh--4);
}
.-bxsh\:5 {
	box-shadow: var(--bxsh--5);
}
.-bxsh\:-1 {
	box-shadow: var(--bxsh--i1);
}
.-bxsh\:-2 {
	box-shadow: var(--bxsh--i2);
}
.-p,
[class*='-p:'] {
	padding: var(--p);
...
@container (min-width: 480px) {
	...
	.-colg_sm {
		-moz-column-gap: var(--colg_sm);
		column-gap: var(--colg_sm);
	}
	.-rowg_sm {
		row-gap: var(--rowg_sm);
	}
...
@container (min-width: 720px) {
	...
	.-colg_md {
		-moz-column-gap: var(--colg_md);
		column-gap: var(--colg_md);
	}
	.-rowg_md {
		row-gap: var(--rowg_md);
	}
