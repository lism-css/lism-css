  ...
  <PreviewArea p='30' nogrid>
    <Stack g="10">
      ...
      <Flex className="set--shadow -g:30" px-s="15">
        <Box bxsh="20" p="30" bdrs="20"><Fragment>Box</Fragment></Box>
        <Box bxsh="40" p="30" bdrs="20"><Fragment>Box</Fragment></Box>
      </Flex>
      <Spacer h="40" />
...
<Preview>
  ...
  <PreviewArea p='20' resize>
    <Lism p={[10, 20, 30]} bd bdw="2px" bdrs={['40', null, '50']} class="set--innerRs">
      <Lism bd p="15" bdrs="inner"><Fragment>Example</Fragment></Lism>
    </Lism>
  </PreviewArea>
  {/* <PreviewCode label="HTML" slot="tab">
  </PreviewCode> */}
