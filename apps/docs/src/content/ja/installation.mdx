...
:::info
`main.css` のほかに、`@layer` を使わない `main_no_layer.css` や、CSS purge ツールとの併用を前提にした全部入りビルドの `full.css` もあります。詳しくは[カスタマイズページ](/docs/customize/build/)をご覧ください。
:::
...
詳しいセットアップ・オプション・safelist の指定方法は [CSS Purge](/docs/customize/purge/) を参照してください。
