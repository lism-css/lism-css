...
[`.is--layer`](/docs/css-methodology//#is--layer)をデフォルトで出力するコンポーネント(`<Lism isLayer>`のエイリアス）です。
...
| プロパティ | 説明 |
|---|---|
| `blur`,`contrast`,`brightness`,`dropShadow`,`grayscale`,`hueRotate`,`invert`,`saturate`,`sepia` | これらをまとめて連結し、 `style.backdropFilter` に受け渡します。|
