...
| プレフィックス | 責務 | レイヤー | 例 |
|---|---|---|---|
| `set--` | HTML 要素の基礎スタイリング / 変数のセット | `lism-base` | `set--plain`, `set--var:hov`, `set--var:bxsh`, `set--var:bdrsInner` |
...
| `u--` | 装飾的効果（単独 / 子要素装飾を含む） | `lism-utility` | `u--trim`, `u--cbox`, `u--divide`, `u--cells`, `u--clipText` |
