      ...
      <Modal.Inner layout="stack" max-w="24rem" h="100%" bxsh="40" offset="-100px 0">
        ...
        <Modal.Body ov-y="auto">
          <Stack className="u--collapseGrid" bd-b p="0" ov="clip">
            <Link href="#menu-link01" set="plain" hov="neutral" px="20" py="15">
              <Fragment>Menu item 1</Fragment>
            </Link>
            <Link href="#menu-link02" set="plain" hov="neutral" px="20" py="15">
              <Fragment>Menu item 2</Fragment>
            </Link>
            <Link href="#menu-link03" set="plain" hov="neutral" px="20" py="15">
              <Fragment>Menu item 3</Fragment>
            </Link>
            <Link href="#menu-link04" set="plain" hov="neutral" px="20" py="15">
