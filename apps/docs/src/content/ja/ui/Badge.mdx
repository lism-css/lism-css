...
<Preview>
  ...
  <PreviewCode slot="tab" label="HTML">
    ...
    <div class="l--cluster -g:15">
      ...
      <span class="c--badge u--cbox -d:inline-flex -fz:xs -lh:xs -py:5 -px:10 -bdrs:99" style="--keycolor:var(--blue)">Badge</span>
    </div>
    ```
  </PreviewCode>
</Preview>
...
<Preview>
  ...
  <PreviewCode slot="tab" label="Badge.tsx">
    <SrcCode dir="lism-ui" path="src/components/Badge/react/Badge.tsx" />
  </PreviewCode>
