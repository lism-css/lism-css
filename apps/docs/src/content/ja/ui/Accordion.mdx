...
```html
<details class="c--accordion -p:15">
	<summary class="c--accordion_header">
		<span class="c--accordion_label">Accordion Label</span>
	...
	<div class="c--accordion_body -my-s:15">
		<div class="c--accordion_inner">
			<p>Lorem ipsum...</p>
		</div>
	</div>
</details>
...
<Preview>
	<PreviewCode slot='tab' label='HTML'>
		```pug
		details.c--accordion
			summary.c--accordion_header
				span.c--accordion_label Accordion Label
				span.c--accordion_icon
					svg.a--icon
			div.c--accordion_body
				div.c--accordion_inner(.l--flow) ...Contents...
		```
	</PreviewCode>
	<PreviewCode slot='tab' label='JSX'>
		```jsx
...
<Preview>
		...
		<Stack bd-y>
			<Accordion.Root>
				<Accordion.Header p="15">
					<Accordion.Label as='h3' f='inherit' fw='bold'>Accordion Label</Accordion.Label>
					<Accordion.Icon>
	...
	<details class="c--accordion -p:15">
		<summary class="c--accordion_header">
			<h3 class="c--accordion_label -f:i -fw:bold">Accordion Label</h3>
			...
	```
	</PreviewCode>
</Preview>
...
また、複数の`<Accordion.Root>`(`.c--accordion`)を含む親要素に `[data-multiple="disallow"]`を指定することで、アコーディオンを複数同時に開くことを禁止することが可能です。
...
<details class="c--accordion -p:15">
	<summary class="c--accordion_header">
		<span class="c--accordion_label">Labelテキスト（<a href="#acc-innerlink">ヘルプリンク</a></span>
		<button class="c--accordion_icon -d:ig -bd -bdrs:5 -bgc:inherit -p:10" data-role="trigger">
			<svg class="a--icon"...>...</svg>
		</button>
	</summary>
	<div class="c--accordion_body -my-s:15">
		<div class="c--accordion_inner">...</div>
	</div>
</details>
```
	</PreviewCode>
...
- `c--accordion` の`summary`要素、または（`data-role="trigger"`があればその要素）に対してクリックイベント・トグルイベントを登録
