...
<Preview>
	...
	<PreviewArea p='20' bg=':stripe' flow='s'>
		<Flex g="15">
		  <HTML.a href="###" d="in-flex" w="fit" td="none" c="base" bgc="text" lh="s" py="10" px="20" bdrs="20" hov="o">
		    Button
		  </HTML.a>
		  <HTML.a href="###" d="in-flex" w="fit" td="none" c="inherit" bd lh="s" py="10" px="20" bdrs="20" hov="o">
		    Button
		  </HTML.a>
		</Flex>
		<Grid
