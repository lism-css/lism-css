  ...
  <PreviewArea resize>
    <Stack isContainer max-sz="full" min-h="50vh" bgc="base-2">
      <Flow isWrapper setGutter my="auto">
        <Text fw="bold" fz="xl"><Fragment>DEMO 01</Fragment></Text>
  ...
  <PreviewArea resize>
    <Stack isContainer max-sz="full" min-h="68vh" g="20" c="white" pos="rel">
      ...
      <Flow isWrapper setGutter my="auto" z="0">
        <Text fw="bold" fz="xl"><Fragment>DEMO 02</Fragment></Text>
        <DummyText length="l" />
      </Flow>
      <Center p="15" z="0"><Fragment>Footer</Fragment></Center>
    </Stack>
  </PreviewArea>
  <PreviewCode>
    ```jsx
  ...
  <PreviewArea resize>
    <Stack isContainer max-sz="full" setGutter pos="rel" min-h="50vh" c="white" g="15">
      ...
      <Flow isWrapper py="30" my="auto" z="0">
        <Heading level="2" fw="bold" fz="xl"><Fragment>ShapeDivider & Layers</Fragment></Heading>
        <DummyText length="l" />
      </Flow>
