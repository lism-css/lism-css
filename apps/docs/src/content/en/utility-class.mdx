...
---
import { Lism, Flow, Grid, Stack, Center, Box, Media, Frame, Flex, Layer, Spacer, Icon, Divider, Text, Inline } from "lism-css/astro";
...
<Preview>
  ...
  <PreviewArea resize p='20'>
    <Lism layout="cluster" g="10">
      <Lism as="span" className="u--cbox" keycolor="red" bd fz="s" lh="s" py="5" px="10" bdrs="99">
        Badge
      </Lism>
      <Lism as="span" className="u--cbox" keycolor="green" bd fz="s" lh="s" py="5" px="10" bdrs="99">
        Badge
      </Lism>
      <Lism as="span" className="u--cbox" keycolor="blue" bd fz="s" lh="s" py="5" px="10" bdrs="99">
        Badge
      </Lism>
    </Lism>
