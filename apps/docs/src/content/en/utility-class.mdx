...
<Preview>
  ...
  <PreviewCode slot="tab" label='JSX'>
    ```jsx
    <Lism className='u--cbox' keycolor='blue' p='20'><DummyText length='codes' /></Lism>
    <Lism className='u--cbox' keycolor='red' bd p='20'><DummyText length='codes' /></Lism>
    <Lism className='u--cbox' keycolor='purple' bd bdc='keycolor:base:25%' p='20'><DummyText length='codes' /></Lism>
    <Lism className='u--cbox' keycolor='#688f04' bd-x-s bdw='4px' p='20'><DummyText length='codes' /></Lism>
    ```
  </PreviewCode>
</Preview>
