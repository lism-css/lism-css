...
|**State Props**|Props for outputting classes classified as [State Modules](/en/docs/css-methodology//#state-modules)|
...
A set of props corresponding to [State Modules](/en/docs/css-methodology/) classes.
...
<Reference>
[Learn about State Modules classes and usage examples](/en/docs/css-methodology/)
</Reference>
