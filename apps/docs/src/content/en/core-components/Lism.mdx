...
Multiple values can be specified using space-separated or comma-separated strings.
...
Like the `set` prop, multiple values can be specified using space-separated or comma-separated strings, and a `-` prefix excludes that identifier.
