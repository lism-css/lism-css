...
|**State Props**|Props for outputting classes classified as [Trait Primitives](/en/docs/css-methodology//#trait-primitives)|
...
```
[className] [lismClass] [l--{layout}] [is--*(State)] [set--*] [u--*] [Property Class...]
```
...
| 4 | Trait primitive | State Props (`isWrapper`, etc.) | `is--wrapper`, `is--layer` |
...
Items 2–4 all belong to [Component Class / Primitive Class](/en/docs/css-methodology/) (CSS layer `lism-components` / `lism-primitives`), while 5–7 are utility-type classes.
