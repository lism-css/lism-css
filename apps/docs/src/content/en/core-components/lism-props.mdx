...
The standard prop for attaching class names to a component. Use it for `c--` base classes (Custom Class) or any other external styles.
...
| # | Prop | Example |
|---|---|---|
| 1 | User-defined class (`className` / `class`) | `c--box`, `c--siteHeader`, `hoge` |
