...
If the media element is placed first and marked with `isSide`, combine `fxd="row-reverse"` to alternate sides horizontally — while still keeping the media on top when stacked.
