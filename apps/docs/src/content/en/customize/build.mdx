...
Note that running the [CLI build](/en/docs/customize/config/#build-css-using-the-lism-css-cli-command) with `isFullMode` enabled also applies the full preset to `main.css`.
