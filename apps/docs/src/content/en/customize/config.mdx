...
By placing a `lism.config.js` (or `lism.config.ts` / `lism.config.mjs`) file in the root of your project, you can customize component behavior (rather than styles).
