...
The styles for any added utility classes are not automatically loaded (see [How to load additional styles](#how-to-load-additional-styles)).
:::
...
:::info
[`full.css`](/en/docs/customize/build/) already includes classes with `xs` enabled (using a provisional value of 360px).
:::
