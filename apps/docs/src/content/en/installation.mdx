...
```html
<link href="https://cdn.jsdelivr.net/npm/lism-css@0.18.0/dist/css/main.css" rel="stylesheet" />
```
...
| `blog-astro-minimal` | Minimal Astro blog with posts and tags only |
| `blog-astro-full` | Astro blog with categories and table of contents |
