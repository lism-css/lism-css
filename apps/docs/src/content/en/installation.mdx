...
A purge plugin that removes unused Lism CSS classes from your production build is bundled with the `lism-css` package. It works in both Vite and Astro projects.
