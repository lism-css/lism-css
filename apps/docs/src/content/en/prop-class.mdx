...
<Preview>
  ...
  ```jsx
  <HTML.p fz="xl" fw="bold" lts="l" ta="center" tt="upper">
    Example text
  </HTML.p>;
  ```
  </PreviewCode>
...
<Preview>
  <PreviewTitle>Examples</PreviewTitle>
  <PreviewArea p='20'>
    <HTML.p c="brand" bgc="base-2" bd p="30">
      Example text
    </HTML.p>
  </PreviewArea>
  <PreviewCode slot="tab" label="HTML">
...
<Preview>
  ...
  <PreviewArea resize p='5'>
    <Box pos="rel" ar="3/2" lh="1" ff="mono">
      <HTML.div pos="abs" l="0" t="0" bgc="base-2" bd p="10">
        A
      </HTML.div>
      <HTML.div pos="abs" l="0" r="0" w="fit" mx="auto" bgc="base-2" bd p="10">
        B
      </HTML.div>
      <HTML.div pos="abs" r="0" t="0" bgc="base-2" bd p="10">
        C
      </HTML.div>
      <HTML.div pos="abs" l="0" t="0" b="0" h="fit" my="auto" bgc="base-2" bd p="10">
        D
      </HTML.div>
      <HTML.div pos="abs" i="0" m="auto" w="fit" h="fit" bgc="base-2" bd p="10">
        E
      </HTML.div>
      <HTML.div pos="abs" r="0" t="0" b="0" h="fit" my="auto" bgc="base-2" bd p="10">
        F
      </HTML.div>
      <HTML.div pos="abs" l="0" b="0" bgc="base-2" bd p="10">
        G
      </HTML.div>
      <HTML.div pos="abs" l="0" r="0" b="0" w="fit" mx="auto" bgc="base-2" bd p="10">
        H
      </HTML.div>
      <HTML.div pos="abs" r="0" b="0" bgc="base-2" bd p="10">
        I
      </HTML.div>
    </Box>
  </PreviewArea>
