...
<Preview>
  ...
  <EmbedCode dirPath="packages/lism-css" srcPath="config/defaults/traits.ts" />
  </PreviewCode>
</Preview>
...
export default {
  ...
  traits: {
    // Add props for Trait Primitive output
    isHoge: 'is--hoge',
  },
};
```
...
- `p='box'` → outputs `-p:box`
- `bdrs='5'` → outputs `-bdrs:5`
- `isHoge` → outputs `is--hoge`

{/* <Box p="box" bd bdrs="5" isHoge>Box</Box> */}
...
{/* <Box p="box" d="flex" bdrs="5" isHoge bd>
<div>Box</div>
<div>Box</div>
</Box> */}
