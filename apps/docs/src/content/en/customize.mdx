...
This also allows you to specify `xs` in object notation on the component side (to also show `xs` in type completion, you need to extend `BreakpointRegistry` as described on the [Responsive page](/en/docs/responsive/#breakpoints-offered-by-type-completion)).
