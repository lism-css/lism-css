...
title: 'Flow (l--flow)'
navtitle: 'l--flow'
description: 'l--flow is a flow layout module that manages spacing between child elements using margin.'
---
...
`l--flow` is a flow layout module that manages spacing between child elements using `margin`.  
