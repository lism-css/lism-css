...
{/* <Reference>
If you simply want to position an element with `position:absolute`, you can also use the `-pos:absolute` class.
...
<Preview>
  ...
  <PreviewArea p='15'>
    <Frame ar="2/1" pos="relative">
      ...
      <Text pos="absolute" b="0" r="0" p="20" lh="1" c="white" fz="xs" o="-10">Photo by xxxxxx</Text>
    </Frame>
  </PreviewArea>
  <PreviewCode>
    ```jsx {3,8,12}
