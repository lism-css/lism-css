...
`SideMain` (`.l--sideMain`) is not dependent on breakpoints, but you can also build a similar layout using [`Grid`](/en/docs/modules/l--grid) where the switch point is controlled by a breakpoint.
