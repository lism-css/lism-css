...
<Preview>
  ...
  <PreviewArea p='20'>
    <BoxLink href="#linkbox-demo01" p="30" bgc="base" bd bdrs="30" hov="o">
      <Group fz="xl" fw="bold">
  ...
  <PreviewCode slot='tab' label='HTML'>
    ```jsx {1} "<a class=\"is--boxLink"
    <a class="is--boxLink -hov:o -p:30 -bgc:base -bd -bdrs:30" href="#linkbox-demo01">
