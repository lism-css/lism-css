---
title: 'Icon'
description: 'Documentation for the Icon module in Lism CSS. A component for rendering SVG icon elements with preset and custom icon support.'
---
...
<EmbedCode dirPath='packages/lism-css' srcPath='src/scss/modules/atomic/_icon.scss' />
