...
title: 'Icon'
navtitle: 'a--icon'
description: 'Documentation for the Icon module in Lism CSS. A module for displaying icon elements.'
---
...
`a--icon` is a module for displaying icon elements.


## CSS

<SrcCode path='src/scss/modules/atomic/_icon.scss' />
