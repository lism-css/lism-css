...
navtitle: 'l--columns'
description: 'l--columns is a column layout module that displays content in the specified number of columns at each breakpoint.'
---
...
`l--columns` is a column layout module that **displays content in the specified number of columns at each breakpoint**.
