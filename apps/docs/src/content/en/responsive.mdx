...
<p class='-my-s:15'>Only a limited set of properties (`p`,`px`,`py`,`m`,`mx`,`my`,`g`,`fz`,`c`,`bgc`,`bdrs`,`bxsh`) — those where having the value always accessible via a CSS variable is considered useful — use this pattern.</p>
