...
The formula works by defining the half-leading amount first, then adding it above and below the cap height (approximately `1em`). When `--lh` is set, it takes precedence.
