...
```html
<link href="https://cdn.jsdelivr.net/npm/lism-css@0.11.0/dist/css/reset.css" rel="stylesheet" />
```
...
:::note
For details on the CSS variables (tokens) used in each style, refer to the [Design Tokens](/docs/tokens/) page.
:::
...
For more details, see [Typography Tokens](/docs/tokens/typography/#lh-line-height).
...
Disabled elements receive an opacity of `--o--n20` (`0.5`), and `:focus-visible` allows the outline offset to be adjusted with `--focus-offset`.
