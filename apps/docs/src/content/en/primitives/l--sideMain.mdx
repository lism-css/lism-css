...
navtitle: 'l--sideMain'
description: 'l--sideMain is a two-column class that automatically switches between horizontal and vertical arrangements based on the content width you want to preserve.'
---
...
<SrcCode path="src/scss/primitives/layout/_sideMain.scss" />
