...
navtitle: 'l--sideMain'
description: 'l--sideMain is a two-column layout module that automatically switches between horizontal and vertical arrangements based on the content width you want to preserve.'
---
import { SideMain, Grid, Box, Stack, Spacer } from 'lism-css/astro';
import { DummyText } from '@lism-css/ui/astro';

`l--sideMain` is a two-column layout module that, without relying on media queries or container queries, **automatically switches between horizontal and vertical arrangements based on the content width you want to preserve**.
