...
title: 'Flow (l--flow)'
navtitle: 'l--flow'
description: 'l--flow is a flow layout primitive that manages spacing between child elements using margin.'
---
...
`l--flow` is a flow layout primitive that manages spacing between child elements using `margin`.  
...
<SrcCode path="src/scss/modules/layout/_flow.scss" />
