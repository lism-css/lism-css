  ...
  <PreviewArea p="20" resize>
    <Grid gtc={['auto', 'auto 1fr']} bd-b>
      <Grid gtc="subgrid" gc="1/-1" g="20" ai="center" bd-t py="20" px="10">
        ...
        <DummyText util="trim" length="s" as="a" href="####" hov="o" c="inherit" td="none" lh="s" />
      </Grid>
      <Grid gtc="subgrid" gc="1/-1" g="20" ai="center" bd-t py="20" px="10">
        <Grid gtc={['auto auto', '1fr 1fr']} g="20" jc="start" ai="center">
        ...
        <DummyText util="trim" offset="2" as="a" href="####" hov="o" c="inherit" td="none" lh="s" />
      </Grid>
      <Grid gtc="subgrid" gc="1/-1" g="20" ai="center" bd-t py="20" px="10">
        <Grid gtc={['auto auto', '1fr 1fr']} g="20" jc="start" ai="center">
        ...
        <DummyText util="trim" length="l" offset="6" as="a" href="####" hov="o" c="inherit" td="none" lh="s" />
      </Grid>
    </Grid>
  </PreviewArea>
  <PreviewCode slot="tab" label="JSX">
