...
navtitle: 'l--tileGrid'
description: 'l--tileGrid is a class for creating uniform tile-style grid layouts by specifying cols and rows.'
---
...
Internally, it uses `grid-template: repeat(rows, minmax(0, 1fr)) / repeat(cols, minmax(0, 1fr))`.


## CSS

<SrcCode path="src/scss/primitives/layout/_tileGrid.scss" />
...
<Preview>
  ...
  <PreviewCode slot="tab" label="HTML">
    ```html "--cols:3;--rows:3"
    <div class="l--tileGrid -g:5 -min-h" style="--cols: 3; --rows: 3; --min-h: 50svh">
      ...
      <div class="l--box -bgc:base-2 -p:20 -gc" style="--gc: span 2">item5</div>
      <div class="l--center -p:20 -bgc -gc -gr:1/-1" style="--bgc: var(--blue); --gc: 3">item6</div>
    </div>
    ```
  </PreviewCode>
</Preview>
