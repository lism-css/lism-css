...
navtitle: 'is--wrapper'
description: 'is--wrapper is a module class that collectively controls the width of its direct child content.'
---
import { Wrapper, Box, Lism, Spacer } from "lism-css/astro";

`is--wrapper` is a module class that collectively controls the width of its direct child content.
