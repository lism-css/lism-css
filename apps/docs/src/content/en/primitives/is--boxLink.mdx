...
navtitle: 'is--boxLink'
description: 'is--boxLink is a primitive class that makes an entire box clickable.'
---
import { BoxLink, Spacer, Group, Link, Text } from 'lism-css/astro';
import { DummyText } from '@lism-css/ui/astro';

`is--boxLink` is a primitive class that makes an entire box clickable.


## CSS

<SrcCode path="src/scss/modules/trait/_boxLink.scss" />
