...
navtitle: 'is--layer'
description: 'is--layer is a primitive class for creating overlay layers absolutely positioned on top of a parent element.'
---
import { Media, Layer, Stack, Flex, Box, Columns, Center, Frame, Text } from 'lism-css/astro';
import { DummyText } from '@lism-css/ui/astro';

`is--layer` is a primitive class for creating overlay layers absolutely positioned on top of a parent element.


## CSS

<SrcCode path="src/scss/modules/trait/_layer.scss" />
