...
<Preview>
  <PreviewTitle>Examples</PreviewTitle>
  <PreviewArea p="30">
    <Text whs="nowrap" ov="hidden" bd p="10" bgc="base-2" max-sz="s">
      <Fragment>whs: nowrap — This long text will not wrap and will overflow</Fragment>
    </Text>
  </PreviewArea>
  <PreviewCode slot="tab" label="HTML">
  ```html
  <p class="-whs:nowrap -ov:hidden -bd -p:10 -bgc:base-2 -max-sz:s">
    whs: nowrap — This long text will not wrap and will overflow
  </p>
  ```
  </PreviewCode>
  <PreviewCode slot="tab" label="JSX">
