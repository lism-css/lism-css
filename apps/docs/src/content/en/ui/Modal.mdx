			...
			<Modal.Inner layout='stack' max-w='24rem' h='100%' bxsh='40' offset='-100px 0'>
				...
				<Modal.Body ov-y='auto'>
					<Stack className='u--collapseGrid' bd-b p='0' ov='clip'>
						<HTML.a href='#menu-link01' c='inherit' hov='neutral' px='20' py='15'>Menu item 1</HTML.a>
						<HTML.a href='#menu-link02' c='inherit' hov='neutral' px='20' py='15'>Menu item 2</HTML.a>
						<HTML.a href='#menu-link03' c='inherit' hov='neutral' px='20' py='15'>Menu item 3</HTML.a>
						<HTML.a href='#menu-link04' c='inherit' hov='neutral' px='20' py='15'>Menu item 4</HTML.a>
					</Stack>
				</Modal.Body>
			</Modal.Inner>
		</Modal.Root>
