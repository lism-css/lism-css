...
import { HTML, Grid, Dummy, Flex, Stack, Center, Icon } from 'lism-css/astro';
		...
		<Modal.Root id="modal-02" isWrapper="s" isContainer px="30" py="50">
		  <Modal.Inner layout="stack" max-h="100%" bdrs="20" bxsh="40">
		    <Flex ai="center" jc="between" py="15" bd-b>
		      <HTML.span fz="l" fw="bold" lh="s" mx-s="30">
		        Modal Header
		      </HTML.span>
		  ...
		  <Modal.Inner layout="stack" max-w="24rem" h="100%" bxsh="40" offset="-100px 0">
		    ...
		    <Modal.Body ov-y="auto">
		      <Stack className="u--collapseGrid" bd-b p="0" ov="clip">
		        <HTML.a href="#menu-link01" c="inherit" hov="neutral" px="20" py="15">
		          Menu item 1
		        </HTML.a>
		        <HTML.a href="#menu-link02" c="inherit" hov="neutral" px="20" py="15">
		          Menu item 2
		        </HTML.a>
		        <HTML.a href="#menu-link03" c="inherit" hov="neutral" px="20" py="15">
		          Menu item 3
		        </HTML.a>
		        <HTML.a href="#menu-link04" c="inherit" hov="neutral" px="20" py="15">
		          Menu item 4
		        </HTML.a>
		      </Stack>
		    </Modal.Body>
