...
<Preview>
  ...
  <PreviewArea p="10">
    <Flex util="snap" ov="auto" g="20" bdrs="20">
...
<Preview>
  ...
  <PreviewArea resize p="10">
    <Flex util="snap" ov="auto" bgc="black" p="20" g="20" bdrs="30" style={{ 'scroll-padding': 'var(--p)' }}>
...
<Preview>
  ...
  <PreviewArea resize p="10">
    <Flex util="snap" ov="auto" g="20" p="15" bgc="black" bdrs="20" style={{ '--snapAlign': 'center' }}>
...
<Preview>
  ...
  <PreviewArea resize p="10">
    <Grid util="snap" ov="auto" gaf="column" gac="100%" g="20" bdrs="20" tabIndex="0">
...
<Preview>
  <PreviewTitle>Preview<SwipeHelp /></PreviewTitle>
  <PreviewArea resize p="10">
    <Grid util="snap" ov="auto" gaf="column" gac="var(--cols)" cols={['70%', '40%']} g="15" bdrs="20" tabIndex="0">
...
<Preview>
  ...
  <PreviewArea resize p="10">
    <Grid util="snap" gaf="column" gac="24rem" g="20">
      <Box bgc="base-2" p="30">
        <DummyText />
      </Box>
...
<Preview>
  ...
  <PreviewArea p="30 20" layout="">
    <Grid util="snap" ov="auto" gaf="column" gac="75%" g="15" bdrs="20" style={{ '--snapAlign': 'center', 'scroll-behavior': 'smooth' }}>
...
<Preview>
  ...
  <PreviewArea resize p="10">
    <Grid util="snap" ov="auto" g="15" gaf={['column', null, 'row']} gac="75%" gtc={[null, null, 'repeat(2, 1fr)']}>
      <ReelImages />
    </Grid>
  </PreviewArea>
  <PreviewCode>
