...
<Preview>
  ...
  <PreviewArea p='10'>
    <Flex className="u--snap" ov="auto" g="20" bdrs="20">
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Flex className="u--snap" ov="auto" bgc="black" p="20" g="20" bdrs="30" style={{ 'scroll-padding': 'var(--p)' }}>
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Flex className="u--snap" ov="auto" g="20" p="15" bgc="black" bdrs="20" style={{ '--snapAlign': 'center' }}>
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Grid className="u--snap" ov="auto" gaf="column" gac="100%" g="20" bdrs="20" tabIndex="0">
...
<Preview>
  <PreviewTitle>Preview<SwipeHelp /></PreviewTitle>
  <PreviewArea resize p='10'>
    <Grid className="u--snap" ov="auto" gaf="column" gac="var(--cols)" cols={['70%', '40%']} g="15" bdrs="20" tabIndex="0">
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Grid className="u--snap" gaf="column" gac="24rem" g="20">
      <Box bgc="base-2" p="30">
        <DummyText />
      </Box>
...
<Preview>
  ...
  <PreviewArea p='30 20' layout=''>
    <Grid className="u--snap" ov="auto" gaf="column" gac="75%" g="15" bdrs="20" style={{ '--snapAlign': 'center', 'scroll-behavior': 'smooth' }}>
    ...
    <Flex g="15" jc="center" lh="1" my-s="15">
      <Lism as="a" href="#image-1" c="inherit" bgc="base-2" w="2em" h="2em" ta="center" ac="center" bdrs="10" td="none" hov="o">
        1
      </Lism>
      <Lism as="a" href="#image-2" c="inherit" bgc="base-2" w="2em" h="2em" ta="center" ac="center" bdrs="10" td="none" hov="o">
        2
      </Lism>
      <Lism as="a" href="#image-3" c="inherit" bgc="base-2" w="2em" h="2em" ta="center" ac="center" bdrs="10" td="none" hov="o">
        3
      </Lism>
      <Lism as="a" href="#image-4" c="inherit" bgc="base-2" w="2em" h="2em" ta="center" ac="center" bdrs="10" td="none" hov="o">
        4
      </Lism>
      <Lism as="a" href="#image-5" c="inherit" bgc="base-2" w="2em" h="2em" ta="center" ac="center" bdrs="10" td="none" hov="o">
        5
      </Lism>
    </Flex>
  </PreviewArea>
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Grid className="u--snap" ov="auto" g="15" gaf={['column', null, 'row']} gac="75%" gtc={[null, null, 'repeat(2, 1fr)']}>
      <ReelImages />
    </Grid>
  </PreviewArea>
  <PreviewCode>
...
<Preview>
  ...
  <PreviewArea resize p='10'>
    <Box max-w="24rem" mx="auto">
      <Box class="u--snap" ov="auto" ar="3/4" bdrs="20" bgc="black">
        <Frame ar="3/4">
