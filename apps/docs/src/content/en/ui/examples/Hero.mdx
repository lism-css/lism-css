...
The following example also uses the opt-in component [`<ShapeDivider>`](/docs/ui/ShapeDivider/).
<Preview>
  <PreviewTitle>With ShapDivide & Layers</PreviewTitle>
  <PreviewArea resize>
    <Stack isContainer max-sz="full" setGutter pos="rel" min-h="50vh" c="white" g="15">
...
<Preview>
  ...
  <PreviewArea resize p='20'>
    <Box max-sz="full" style={{ '--slopeH': 'clamp(2rem, 4cqw, 4rem)' }}>
      ...
      <Stack isContainer max-sz="full" setGutter pos="rel" min-h="50vh" c="white" my-s="calc(0px - var(--slopeH))">
        <Frame
          isLayer
          style={{
