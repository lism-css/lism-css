...
<div class="c--accordion l--stack">
  <div class="c--accordion_item">
    <div class="c--accordion_heading set--plain" role="heading">
      <button class="c--accordion_button l--flex set--plain -g:10 -w:100% -ai:center -jc:between -p:20" aria-controls="{id}" aria-expanded="false">
        Accordion Example 1
        <span class="c--accordion_icon a--icon -pi:center -fxsh:0" aria-hidden="true"></span>
      </button>
    </div>
    <div class="c--accordion_panel -pos:relative -ov:hidden" id="{id}" hidden="until-found">
      <div class="c--accordion_content l--flow -p:20 -pt:5">
        ...Contents...
      </div>
    </div>
  </div>
  <div class="c--accordion_item -bd-t">
    ...
  </div>
</div>
```
...
| <PropBadge>`<Accordion.Panel>`</PropBadge><br/>`flow` | Flow layout setting passed to the content area (`_content`) inside the panel. |
...
<div class="c--accordion l--stack">
  <div class="c--accordion_item" data-opened>
    <!-- button: aria-expanded="true" / panel: no hidden -->
    ...
  </div>
  <div class="c--accordion_item">...</div>
</div>
