...
<Preview>
  ...
  <PreviewCode slot="tab" label="JS">
    <SrcCode dir="lism-ui" path="src/components/Accordion/setAccordion.ts" title="setAccordion.ts"/>
  </PreviewCode>
  <PreviewCode slot="tab" label="React">
    <SrcCode dir="lism-ui" path="src/components/Accordion/react/Accordion.tsx" title="Accordion.tsx"/>
  </PreviewCode>
</Preview>
