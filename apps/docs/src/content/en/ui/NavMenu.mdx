...
The source code is available on [GitHub](https://github.com/lism-css/lism-css/tree/main/packages/lism-ui/src/components/NavMenu).
...
<Preview>
  ...
  <PreviewArea p="30">
    <NavMenu.Root>
      <NavMenu.Item>
        <NavMenu.Link href="#menu1" g="15" ai="center" bgc="text" c="base" hov="-bgc">
          <span>Menu item</span>
      ...
      <NavMenu.Item>
        <NavMenu.Link href="#menu2" g="15" ai="center" bgc="text" c="base" hov="-bgc">
          <span>Menu item</span>
          <Icon icon="caret-right" ms="auto" />
        </NavMenu.Link>
      </NavMenu.Item>
      <NavMenu.Item>
        <NavMenu.Link href="#menu3" g="15" ai="center" bgc="text" c="base" hov="-bgc">
          <span>Menu item</span>
          <Icon icon="caret-right" ms="auto" />
        </NavMenu.Link>
      </NavMenu.Item>
