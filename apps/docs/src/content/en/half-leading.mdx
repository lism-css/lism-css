...
Lism provides the tokens `--hl--xs` through `--hl--xl` as values for `--hl`, and `--lh--xs` through `--lh--xl` as values for `--lh`. See the [HL](/en/docs/tokens/typography/#hl-half-leading) / [LH](/en/docs/tokens/typography/#lh-line-height) sections of Typography Tokens for the full list and a preview.
