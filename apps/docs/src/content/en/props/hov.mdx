...
The [`set--transition`](/docs/set-class/#set--transition) class is available for this purpose.
...
Lism defines a class called [`set--hov`](/docs/set-class/#set--hov), which sets up the `--_isHov` and `--_notHov` variables.
