	...
	<PreviewArea p='20'>
		<Frame isLinkBox setHov href='#banner-link' ar='16/9' bdrs='30'>
			...
			<Layer setTransition hov='to:show' bgc='rgb(0 0 0 / 40%)' blur='6px'>
				<Center h='100%' c='#fff'>
					<HTML.span fz='2xl' fs='italic' fw='light' lts='l' bdrs='99' px='20' py='10'>View More</HTML.span>
				</Center>
			</Layer>
		</Frame>
	</PreviewArea>
	...
	<PreviewArea p='20'>
		...
		>
			...
			<Center isLayer c='#fff' bgc='rgb(0 0 0 / 40%)'>
				<HTML.p setTransition hov='to:letterSpread' fz='2xl'>LinkBox</HTML.p>
			</Center>
		</LinkBox>
	</PreviewArea>
