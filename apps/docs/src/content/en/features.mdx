...
Lism CSS, drawing inspiration from [Every Layout](https://every-layout.dev/), includes several **layout modules that automatically adapt to their container's width without relying on queries**.
