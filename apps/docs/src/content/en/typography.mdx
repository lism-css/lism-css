...
<Preview>
  ...
  <PreviewArea p='20' flow='s'>
    <Text ff="base" fz="xl"><Fragment>base: English text, 漢字ひらがな</Fragment></Text>
    <Text ff="accent" fz="xl"><Fragment>accent: English text, 漢字ひらがな</Fragment></Text>
    <Text ff="mono" fz="xl"><Fragment>mono: English text, 漢字ひらがな</Fragment></Text>
  </PreviewArea>
  <PreviewCode>
  ```jsx
...
|`semibold`|`--fw--semibold`|`-fw:semibold`|`600`|
