...
You can also fetch the same skill with `lism-cli skill add`. It only supports installing into the project directory, but offers the `skill check` command to compare the bundled skill with your local files.
