...
<table className="l--table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The layer for Reset CSS, token definitions, variable sets, and initial element styles.<br/>`set--{name}` classes are also defined here.</td>
    </tr>
    <tr>
...
|---|---|---|
|Set Class|`set--{name}`|`set--plain`,<br />`set--hov`,<br />`set--bxsh`|
...
| Category | Format | Example |
|---|---|---|
|Utility Class|`u--{name}`|`u--cbox`,<br/>`u--trim`|
