...
<table className="l--table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>A layer for user-defined custom classification classes (`.z--{zone}`, `.p--{page}`, etc.).</td>
    </tr>
    <tr>
...
When defining your own components (`.c--card`, `c--pricing`, etc.), place them inside `@layer lism-modules`.
