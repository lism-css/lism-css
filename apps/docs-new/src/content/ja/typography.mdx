...
<Preview>
	...
	<Dummy pre='<code class="-fz:s">1:</code> ' lh='1' bd bds='dotted' />
		<Dummy pre='<code class="-fz:s">xs:</code> ' lh='xs' bd bds='dotted' />
		<Dummy pre='<code class="-fz:s">s:</code> ' lh='s' bd bds='dotted' />
		<Dummy pre='<code class="-fz:s">base:</code> ' lh='base' bd bds='dotted' />
		<Dummy pre='<code class="-fz:s">l:</code> ' lh='l' bd bds='dotted' />
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```html
