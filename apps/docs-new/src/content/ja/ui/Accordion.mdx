...
<EmbedCode dirPath='packages/lism-ui' srcPath='src/components/Accordion/_style.css' />


## JavaScript

<EmbedCode dirPath='packages/lism-ui' srcPath='src/components/Accordion/setAccordion.js' />
