...
import { Preview, PreviewArea, PreviewTitle, PreviewCode, ImportPackage, EmbedCode, IconBadge, PropBadge } from '@/components/mdx';
...
<EmbedCode dirPath='packages/lism-ui' srcPath='src/components/Modal/_style.css' />


## JavaScript

<EmbedCode dirPath='packages/lism-ui' srcPath='src/components/Modal/setModal.ts' />
