...
import { Preview, PreviewArea, PreviewTitle, PreviewCode, ImportSource, ImportExComponent, PropBadge } from "@/components/mdx";
...
<Preview>
	...
	<PreviewArea resize p='10'>
		<Flex className='set-snap' ov='auto' g='20' p='15' bgc='black' bdrs='20' style={{ '--snapAlign': 'center' }}>
...
<Preview>
	...
	<PreviewArea p='30 20' layout=''>
		<Grid className='set-snap' ov='auto' gaf='column' gac='75%' g='15' bdrs='20' style={{ '--snapAlign': 'center', 'scroll-behavior': 'smooth' }}>
