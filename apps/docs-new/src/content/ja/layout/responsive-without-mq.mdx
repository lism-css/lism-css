...
<Preview src="without-mq/mq-problem" addFiles={['../_layout.css']} resize useLism/>
...
<Preview src="without-mq/cq-example" addFiles={['../_layout.css']} useLism/>
...
<Preview src="without-mq/sideMain" addFiles={['../_layout.css']} useLism />
...
<Preview src="without-mq/liquid-grid" resize ar="2/1" useLism />
...
<Preview resize title='auto-fill, --cols:160px'>
...
<Preview resize title='2列目以降の挙動を確認'>
<div class='l--fluidCols -g:20' style='--autoMode: auto-fit;--cols:160px'>
  <div class='-p:20 -bgc:base-2'>auto-fit</div>
  <div class='-p:20 -bgc:base-2'>auto-fit</div>
  <div class='-p:20 -bgc:base-2'>auto-fit</div>
...
<Preview resize title='子要素: flex-basis:160px, flex-grow:1' css={`div{flex-basis:160px}`}>
...
<Preview src="without-mq/switcher" resize useLism/>
