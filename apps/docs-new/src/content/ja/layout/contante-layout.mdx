...
import PreviewSrcCodes from '@/components/mdx/Preview/PreviewSrcCodes.astro';
...
<PreviewSrcCodes src="content-layout" srcFiles={['_typography.css']} />
...
{/* <Preview src="content-layout/flow" resize _srcFiles={null} /> */}
...
<Preview src="content-layout/demo" resize />
...
<Preview src="content-layout/fullwide-cqw" resize ar="2/1" title="@propertyとcqwを使った全幅サイズ管理のデモ" />
