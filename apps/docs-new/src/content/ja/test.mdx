...
<Demo useLism title='padding, gap にどちらも同じ余白を設定しているが、左右と上下で余白感が異なる例' css={`
...
<Demo src="clamp/ex-tokens" resize ar='2/1' _addFiles={['./../hogehogheogheoghe.html','./../foooooo.html']}/>
